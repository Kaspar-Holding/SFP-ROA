                    ...
                    <tbody>
                        {
                            Object.keys(formList).map((keyName, i) => (
                                <tr>
                                    ...
                                    <td>
                                        <NavLink type="button" to={{pathname:"/completeform"}} state={{formId : formList[i]['id'], advisorId : formList[i]['advisorId'], clientIdNumber: formList['clientIdNumber']}} className="btn btn-sm btn-outline-primary">Edit</NavLink>
