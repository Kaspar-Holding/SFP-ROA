...
function AssuranceInvestment()
{
    ...
    function letter_of_introduction_onFocus() {
      ...
      const [FormData, setFormData] = useState({
        ...
        AI_PF_1 : "",
        AI_PF_Percentage1 : "",
        AI_PF_Provided1 : true,
        AI_PF_Discussed1 : true,

        AI_PF_2 : "",
        AI_PF_Percentage2 : "",
        AI_PF_Provided2 : true,
        AI_PF_Discussed2 : true,

        AI_PF_3 : "",
        AI_PF_Percentage3 : "",
        AI_PF_Provided3 : true,
        AI_PF_Discussed3 : true,

        AI_PF_4 : "",
        AI_PF_Percentage4 : "",
        AI_PF_Provided4 : true,
        AI_PF_Discussed4 : true,

        AI_PF_5 : "",
        AI_PF_Percentage5 : "",
        AI_PF_Provided5 : true,
        AI_PF_Discussed5 : true,

        AI_PF_6 : "",
        AI_PF_Percentage6 : "",
        AI_PF_Provided6 : true,
        AI_PF_Discussed6 : true,

        AI_PF_7 : "",
        AI_PF_Reasons : "",
        AI_PF_Provided7 : true,
        AI_PF_Discussed7 : true,
                ...
                <div className="col-6">
                    <div className="row">
                        <div className="row col-2 align-items-center">
                            <div className="col-2">
                                <input className="form-check-input" checked={FormData['AI_Premium'] == 1 ? true : false} name="AI_Premium" onChange={(e) => {onChange(e)}} type="radio" value="1" />
                            </div>
                            <div className="col-2">
                        ...
                        <div className="row col-2 align-items-center">
                            <div className="col-2">
                                <input className="form-check-input" checked={FormData['AI_Premium'] == 1 ? false : true} name="AI_Premium" onChange={(e) => {onChange(e)}} type="radio" value="0" />
                            </div>
                            <div className="col-2">
                                <label className="form-check-label" htmlFor="provided_identity_radio_btn3" >
                                    Recurring
  ...
  <table className="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
        <td> 
            <input type="checkbox"  checked={FormData['AI_PF_Provided']}  name="AI_PF_Provided" onChange={(e) => {onChange(e)}} />
            <label> Yes</label>
        </td>

        <td>
            <input type="checkbox"  checked={FormData['AI_PF_Discussed']}  name="AI_PF_Discussed" onChange={(e) => {onChange(e)}}/>
            <label> Yes</label>
        </td>     
      </tr>
      ...
      <tr>
        ...
        {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
        <td> 
            <input type="checkbox"  checked={FormData['AI_PF_Provided1']}  name="AI_PF_Provided1" onChange={(e) => {onChange(e)}} />
            <label> Yes</label>
        </td>

        <td>
            <input type="checkbox"  checked={FormData['AI_PF_Discussed1']}  name="AI_PF_Discussed1" onChange={(e) => {onChange(e)}}/>
            <label> Yes</label>
        </td>   
      </tr>
      ...
      <tr>
        ...
        {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
        <td> 
            <input type="checkbox"  checked={FormData['AI_PF_Provided3']}  name="AI_PF_Provided3" onChange={(e) => {onChange(e)}} />
            <label> Yes</label>
        </td>

        <td>
            <input type="checkbox"  checked={FormData['AI_PF_Discussed3']}  name="AI_PF_Discussed3" onChange={(e) => {onChange(e)}}/>
            <label> Yes</label>
        </td>     
      </tr>
      ...
      <tr>
        ...
        {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
        <td> 
            <input type="checkbox"  checked={FormData['AI_PF_Provided4']}  name="AI_PF_Provided4" onChange={(e) => {onChange(e)}} />
            <label> Yes</label>
        </td>

        <td>
            <input type="checkbox"  checked={FormData['AI_PF_Discussed4']}  name="AI_PF_Discussed4" onChange={(e) => {onChange(e)}}/>
            <label> Yes</label>
        </td>   
      </tr>
      ...
      <tr>
        ...
        {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
        <td> 
            <input type="checkbox"  checked={FormData['AI_PF_Provided5']}  name="AI_PF_Provided5" onChange={(e) => {onChange(e)}} />
            <label> Yes</label>
        </td>

        <td>
            <input type="checkbox"  checked={FormData['AI_PF_Discussed5']}  name="AI_PF_Discussed5" onChange={(e) => {onChange(e)}}/>
            <label> Yes</label>
        </td>     
      </tr>
      ...
      <tr>
        ...
        {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
        <td> 
            <input type="checkbox"  checked={FormData['AI_PF_Provided6']}  name="AI_PF_Provided6" onChange={(e) => {onChange(e)}} />
            <label> Yes</label>
        </td>

        <td>
            <input type="checkbox"  checked={FormData['AI_PF_Discussed6']}  name="AI_PF_Discussed6" onChange={(e) => {onChange(e)}}/>
            <label> Yes</label>
        </td>
      </tr>
      ...
      <tr>
        ...
        {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
        <td> 
            <input type="checkbox"  checked={FormData['AI_PF_Provided7']}  name="AI_PF_Provided7" onChange={(e) => {onChange(e)}} />
            <label> Yes</label>
        </td>

        <td>
            <input type="checkbox"  checked={FormData['AI_PF_Discussed7']}  name="AI_PF_Discussed7" onChange={(e) => {onChange(e)}}/>
            <label> Yes</label>
        </td>  
      </tr>
