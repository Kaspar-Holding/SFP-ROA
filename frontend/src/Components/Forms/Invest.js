        ...
        <>
            ...
            <table className="table">
                ...
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided"] == 1 ? true : false} name="IP_ItP_FundProvided" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed"] == 1 ? true : false} name="IP_ItP_FundDiscussed" onChange={(e) => {onChange(e)}} value="1"/>
                ...
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided1"] == 1 ? true : false} name="IP_ItP_FundProvided1" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed1"] == 1 ? true : false} name="IP_ItP_FundDiscussed1" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> No</label>
                    </td>     
                </tr>
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided2"] == 1 ? true : false} name="IP_ItP_FundProvided2" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed2"] == 1 ? true : false} name="IP_ItP_FundDiscussed2" onChange={(e) => {onChange(e)}} value="0"/>
                        <label for="vehicle1"> No</label>
                    </td>     
                </tr>
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided3"] == 1 ? true : false} name="IP_ItP_FundProvided3" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed3"] == 1 ? true : false} name="IP_ItP_FundDiscussed3" onChange={(e) => {onChange(e)}} value="0"/>
                        <label for="vehicle1"> No</label>
                    </td>     
                </tr>
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided4"] == 1 ? true : false} name="IP_ItP_FundProvided4" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed4"] == 1 ? true : false} name="IP_ItP_FundDiscussed4" onChange={(e) => {onChange(e)}} value="0"/>
                        <label for="vehicle1"> No</label>
                    </td>     
                </tr>
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided5"] == 1 ? true : false} name="IP_ItP_FundProvided5" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed5"] == 1 ? true : false} name="IP_ItP_FundDiscussed5" onChange={(e) => {onChange(e)}} value="0"/>
                        <label for="vehicle1"> No</label>
                    </td>     
                </tr>
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided6"] == 1 ? true : false} name="IP_ItP_FundProvided6" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed6"] == 1 ? true : false} name="IP_ItP_FundDiscussed6" onChange={(e) => {onChange(e)}} value="0"/>
                        <label for="vehicle1"> No</label>
                    </td>     
                </tr>
                <tr>
                    ...
                    {/* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; */}
                    <td> 
                        <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundProvided7"] == 1 ? true : false} name="IP_ItP_FundProvided5" onChange={(e) => {onChange(e)}} value="1"/>
                        <label for="vehicle1"> Yes</label>
                    </td>

                    <td>
                    <input type="checkbox" id="vehicle1" checked={FormData["IP_ItP_FundDiscussed7"] == 1 ? true : false} name="IP_ItP_FundDiscussed5" onChange={(e) => {onChange(e)}} value="0"/>
                    <label for="vehicle1"> No</label>
                </td>     
            </tr>
