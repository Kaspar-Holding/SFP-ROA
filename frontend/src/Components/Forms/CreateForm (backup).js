    ...
    return (
      ...
      <main className="container">
                                  ...
                                  </div>
                                  {
                                      ...
                                      <>
                                          <div className="col-11" id="letter_of_introduction_2">
                                              ...
                                              <textarea  id="letter_of_introduction" name="letter_of_introduction" onChange={(e) => {setletterOfIntroductionReason(e.target.value)}} onFocus={letter_of_introduction_onFocus} onBlur={letter_of_introduction_onBlur} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea>
                                          </div>
                                      </>
                                  }
                              </div>
                              ...
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                      <div className="row">
                                          <div className="row col-2 align-items-center">
                                              <div className="col-2">
                                                  <input className="form-check-input" checked={letterOfIntroductionAccess ? true : false} onChange={(e) => {setletterOfIntroductionAccess(true)}} type="radio" value="0" id="authority_access_radio_btn" name="authority_access_radio_btn" />
                                              </div>
                                              <div className="col-2">
                                          ...
                                          <div className="row col-2 align-items-center">
                                              <div className="col-2">
                                                  <input className="form-check-input" checked={letterOfIntroductionAccess ? false : true} onChange={(e) => {setletterOfIntroductionAccess(false)}} type="radio" value="1" id="authority_access_radio_btn" name="authority_access_radio_btn" />
                                              </div>
                                              <div className="col-2">
                                                  <label className="form-check-label" htmlFor="authority_access_radio_btn" >
                                                      No
                                  ...
                                  </div>
                                  {
                                      ...
                                      <>
                                          <div className="col-11" id="authority_access_2" >
                                              ...
                                              <textarea  id="authority_access" name="authority_access" onChange={(e) => {setletterOfIntroductionAccessReason(e.target.value)}} onFocus={letter_of_introduction_access_onFocus} onBlur={letter_of_introduction_access_onBlur} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea>
                                          </div>
                                      </>
                                  }
                              </div>
                                  ...
                                  </div>
                                  {
                                      ...
                                      <>
                                          <div className="col-11" id="provided_identity_2" >
                                              ...
                                              <textarea  id="provided_identity" name="provided_identity" onChange={(e) => {setFicaReason(e.target.value)}} onFocus={fica_onFocus} onBlur={fica_onBlur} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea>
                                          </div>
                                      </>
                                  }
                              </div>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="assurance1-tab" data-bs-toggle="tab" data-bs-target="#assurance1" type="button" role="tab" aria-controls="assurance1" aria-selected="false">Assurance Risk</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="assurance2-tab" data-bs-toggle="tab" data-bs-target="#assurance2" type="button" role="tab" aria-controls="assurance2" aria-selected="false">Assurance Invesment</button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="Short-term-Commercial-tab" data-bs-toggle="tab" data-bs-target="#Short-term-Commercial" type="button" role="tab" aria-controls="Short-term-Commercial" aria-selected="false">Short-term Commercial</button>
            </li>
            <br/>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="Short-term-Personal-tab" data-bs-toggle="tab" data-bs-target="#Short-term-Personal" type="button" role="tab" aria-controls="Short-term-Personal" aria-selected="false">Short-term Personal</button>
            </li>
            </ul>
