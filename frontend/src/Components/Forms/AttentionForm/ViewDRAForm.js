...
const ViewDRAForm = ({user, isAuthenticated}) => {
    ...
    const handleChange1 = (f) => {
        ...
        const LoadRFForm = async(advisorId, userId, formId) => {
            ...
            try {
                const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/view_high_risk_factors_data/`, Body ,config)
        ...
        const updateFormStatus = async(status) => {
            ...
            const Body = JSON.stringify({
                'formId' : searchParams.get("formId"), 
                'formStatus': status,
                'adminId' : searchParams.get("userId")
            })
            try {
                const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/change_high_risk_factors_status/`, Body ,config)
                // console.log(response.data['code'])
                if (response.status === 200){
                    // setSubmissionMessage("User Account Created Successfully")
                    setFormData(response.data['Data'])
                    setSuccessMessage("Form Status has been updated.")
                    setSuccessMessageVisibility("block")
                    setTimeout(() => {
                        setSuccessMessageVisibility("none")
                        return <Navigate to='/' />
        ...
        useEffect(() => {
            if (user){
                console.log(user)
                LoadRFForm(user['id'], searchParams.get("userId"), searchParams.get("formId"))
            }
        ...
        //   setSuccessMessage("You do not have access to view this.")
        //   setSuccessMessageVisibility("block")
        //   setTimeout(() => {
        //       setSuccessMessageVisibility("none")
        //       return <Navigate to='/' />
    ...
    <>
    {
                            ...
                            <div className='row'>
                                <div className='col-6'>
                                    <form onSubmit={e => onFormStatusUpdateSubmit(e,0)}>
                                        <button type='submit' className='btn btn-success col-8'>Approve</button>
                                    </form>
                                </div>
                                <div className='col-6'>
                                    <form onSubmit={e => onFormStatusUpdateSubmit(e,3)}>
                                        <button type='submit' className='btn btn-danger col-8'>Deny</button>
                                    </form>
                                </div>
                            </div>
                        </div>  
                    ...
                    <div className="row">
                        ...
                        <div className="col-6" style={{paddingBottom: "0.5%"}}>
                            <div className="row g-3 align-items-center">
                                ...
                                <div className="col-6">
                                    <input disabled spellCheck="true"  id="RF_ClientId" name="RF_ClientId" value={FormData['RF_ClientId']} className="form-control" onChange={(e) => {onChange(e)}}  placeholder="Client ID"  aria-describedby="" />
                                </div>
                            </div>
                        </div>
            ...
            <div className="row">
                ...
                {(() => { 
                    ...
                    if(FormData['RF_ClientType']==="1")
                    {
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_CountryOfResidence' id='RF_CountryOfResidence' value={parseInt(FormData['RF_CountryOfResidence'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                                <option value="1">Afghanistan</option>
                                <option value="2">Albania</option>
                                <option value="3">Algeria</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Nationality' id='RF_Nationality' value={parseInt(FormData['RF_Nationality'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                                <option value="1">Afghanistan</option>
                                <option value="2">Albania</option>
                                <option value="3">Algeria</option>
                        ...
                        {(() => { 
                            ...
                            if(parseInt(FormData['RF_Different_Nationality'])===1)
                            {
                                return (<>
                                    ...
                                    <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_CountryOfTax' id='RF_CountryOfTax' value={parseInt(FormData['RF_CountryOfTax'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                    <option value="0" selected>Select Option</option>
                                    <option value="1">Afghanistan</option>
                                    <option value="2">Albania</option>
                                    <option value="3">Algeria</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Industry' id='RF_Industry' value={parseInt(FormData['RF_Industry'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_SourceOfFunds'  id='RF_SourceOfFunds' value={parseInt(FormData['RF_SourceOfFunds'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_RelationshipToClient' id='RF_RelationshipToClient' value={parseInt(FormData['RF_RelationshipToClient'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
            ...
            <div className="row">
                ...
                {(() => { 
                    ...
                    if(FormData['RF_ClientType']==="2")
                    {
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_CountryOfRegistration' id='RF_CountryOfRegistration' value={parseInt(FormData['RF_CountryOfRegistration'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                                <option value="1">Afghanistan</option>
                                <option value="2">Albania</option>
                                <option value="3">Algeria</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Type_Legal_Entity' id='RF_Type_Legal_Entity' value={FormData['RF_Type_Legal_Entity']} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Client_Relationship' id='RF_Client_Relationship' value={parseInt(FormData['RF_RelationshipToClient'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                                <option value="1">Annuitant</option>
                                <option value="2">Applicant</option>
                                <option value="3">Authorised Representative</option>
        ...
        <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
            <div className="row">
                ...
                <div className="col-2">
                    ...
                    {/* <input disabled spellCheck="true" id="RF_Product_Category" name='RF_Product_Category' value={FormData['RF_Product_Category']} className="form-control" onChange={(e)=>{onChange(e)}} placeholder=""  aria-describedby="" /> */}
                </div>
        ...
        <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
            <div className="row">
                ...
                <div className="col-2">
                    <select disabled className="text-start form-select" name='RF_Transaction_Flow' id='RF_Transaction_Flow'  value={parseInt(FormData['RF_Transaction_Flow'])} onChange={(e)=>{onChange(e)}} aria-label="Default select example">
                        <option value="0" selected>Select Option</option>
        ...
        <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
            <div className="row">
                ...
                {(() => { 
                    ...
                    if(parseInt(FormData['RF_Transaction_Flow'])===1 || parseInt(FormData['RF_Transaction_Flow'])===2)
                    {
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_High_Transaction_Reason' id='RF_High_Transaction_Reason' value={parseInt(FormData['RF_High_Transaction_Reason'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                                <option value="1">Yes</option>
                                <option value="2">No</option>     
                            </select>    
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Transaction_Frequency' id='RF_Transaction_Frequency' value={parseInt(FormData['RF_Transaction_Frequency'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Transaction_Geography' id='RF_Transaction_Geography' value={parseInt(FormData['RF_Transaction_Geography'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                        ...
                        {(() => {
                            ...
                            if(parseInt(FormData['RF_Transaction_Geography'])===1)
                            {
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_Funds_Jurisdiction' value={parseInt(FormData['RF_Funds_Jurisdiction'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                        <option value="0" selected>Select Option</option>
                                        <option value="1">Afghanistan</option>
                                        <option value="2">Albania</option>
                                        <option value="3">Algeria</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Delivery_Channel' id='RF_Delivery_Channel' value={parseInt(FormData['RF_Delivery_Channel'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Linked_Party_Acting' id='RF_Linked_Party_Acting' value={parseInt(FormData['RF_Linked_Party_Acting'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Linked_Party_Paying' id='RF_Linked_Party_Paying' value={parseInt(FormData['RF_Linked_Party_Paying'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                                <option value="1">Not applicable</option>
            ...
            <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
                <div className="row">
                    ...
                    <div className="col-2">
                        <select disabled className="text-start form-select" name='RF_Client_Match' id='RF_Client_Match'  value={parseInt(FormData['RF_Client_Match'])} onChange={(e)=>{onChange(e)}} aria-label="Default select example">
                            <option value="0" selected>Select Option</option>
            ...
            <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
                <div className="row">
                    ...
                    <div className="col-2">
                        <select disabled className="text-start form-select" name='RF_Client_Beneficiaries' id='RF_Client_Beneficiaries' value={parseInt(FormData['RF_Client_Beneficiaries'])} onChange={(e)=>{onChange(e)}} aria-label="Default select example">
                            <option value="0" selected>Select Option</option>
                            <option value="1">Yes</option>
                            <option value="2">No</option>
                        </select>  
                    </div>
                    {
                        ...
                        LP_Data.map((key,i) => {
                            ...
                            return (<>
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_LP_Adjust_Risk' id='RF_LP_Adjust_Risk' value={key.RF_LP_Adjust_Risk} onChange={(e)=>{on_LP_Change(e,i)}} aria-label="Default select example">
                                ...
                                <div className="col-2">
                                <input disabled spellCheck="true" id="RF_LP_Name" name='RF_LP_Name' className="form-control" required={parseInt(FormData['RF_Client_Beneficiaries'])===1? true : false} value={key.RF_LP_Name}  onChange={(e) => {on_LP_Change(e,i)}} placeholder=""  aria-describedby="" />
                                </div>
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_LP_Client_Relationship' required={parseInt(FormData['RF_Client_Beneficiaries'])===1? true : false} id='RF_LP_Client_Relationship' value={key.RF_LP_Client_Relationship} onChange={(e) => {on_LP_Change(e,i)}} aria-label="Default select example">
                                        <option value="0" selected>Select Option</option>
                                ...
                                <div className="col-2">
                                    <input disabled spellCheck="true" id="RF_LP_ID" name='RF_LP_ID' required={parseInt(FormData['RF_Client_Beneficiaries'])===1? true : false} className="form-control" value={key.RF_LP_ID} onChange={(e) => {on_LP_Change(e,i)}} placeholder=""  aria-describedby="" />
                                </div>
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_LP_Linked_Party' id='RF_LP_Linked_Party' required={parseInt(FormData['RF_Client_Beneficiaries'])===1? true : false} value={parseInt(key.RF_LP_Linked_Party)} onChange={(e)=>{on_LP_Change(e,i)}} aria-label="Default select example">
                                        <option value="0" selected>Select Option</option>
                                        <option value="1">Adverse Media</option>
                                        <option value="2">Enforcement,SIP,SIE</option>
                                        <option value="3">False Positive</option>
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_LP_RCA' id='RF_LP_RCA' value={parseInt(key.RF_LP_RCA)} onChange={(e)=>{on_LP_Change(e,i)}} aria-label="Default select example">
                                        <option value="0" selected>Select Option</option>
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                    </select>  
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_LP_Birth_Country' id='RF_LP_Birth_Country' value={parseInt(key.RF_LP_Birth_Country)} onChange={(e)=>{on_LP_Change(e,i)}}  aria-label="Default select example">
                                        <option value="0" selected>Select Option</option>
                                        <option value="1">Afghanistan</option>
                                        <option value="2">Albania</option>
                                        <option value="3">Algeria</option>
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_LP_Residence_Country' id='RF_LP_Residence_Country' value={key.RF_LP_Residence_Country} onChange={(e)=>{on_LP_Change(e,i)}}  aria-label="Default select example">
                                        <option value="0" selected>Select Option</option>
                                        <option value="1">Afghanistan</option>
                                        <option value="2">Albania</option>
                                        <option value="3">Algeria</option>
                                ...
                                <div className="col-2">
                                    <select disabled className="text-start form-select" name='RF_LP_Nationality' id='RF_LP_Nationality' value={key.RF_LP_Nationality} onChange={(e)=>{on_LP_Change(e,i)}}  aria-label="Default select example">
                                        <option value="0" selected>Select Option</option>
                                        <option value="1">Afghanistan</option>
                                        <option value="2">Albania</option>
                                        <option value="3">Algeria</option>
...
export default connect(mapStateToProps)(ViewDRAForm)