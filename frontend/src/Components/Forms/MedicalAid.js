...
// import './Invest.css';
 function  MedicalAid()
 {
    ...
    return(
        ...
        <>
             <br/>
        <div className="text-start "style={{ color: "#14848A" ,fontSize:'30px',fontFamily:'Arial Bold',fontWeight:'bold'}} > <b>MEDICAL SCHEMES ANALYSIS</b></div>
       <hr/>
       <div className="row">
...
>>>>>>> e87d0c5d1ad40a2591ee1e2bda3f64c9a3e88638
