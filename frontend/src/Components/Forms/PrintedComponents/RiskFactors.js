            ...
            <div className="row">
                ...
                {(() => { 
                    ...
                    if(parseInt(FormData['RF_Transaction_Flow'])===1 || parseInt(FormData['RF_Transaction_Flow'])===2)
                    {
                        ...
                        <div className="col-2">
                            <select disabled className="text-start form-select" name='RF_Delivery_Channel' id='RF_Delivery_Channel' value={parseInt(FormData['RF_Transaction_Geography'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                <option value="0" selected>Select Option</option>
                    ...
                    {(() => { 
                            ...
                            if(parseInt(FormData['RF_Client_Beneficiaries'])===1)
                            {
                                return (<>
                                    ...
                                    <div className="col-2">
                                        <select disabled className="text-start form-select" name='RF_Adjust_Risk1' id='RF_Adjust_Risk1' value={parseInt(FormData['RF_Adjust_Risk1'])} onChange={(e)=>{onChange(e)}} aria-label="Default select example">
                                    ...
                                    <div className="col-2">
                                        <select disabled className="text-start form-select" name='RF_Linked_Party' id='RF_Linked_Party' value={parseInt(FormData['RF_Linked_Party'])} onChange={(e)=>{onChange(e)}} aria-label="Default select example">
                                            <option value="0" selected>Select Option</option>
                                            <option value="1">Adverse Media</option>
                                            <option value="2">Enforcement,SIP,SIE</option>
                                            <option value="3">False Positive</option>
                                    ...
                                    <div className="col-2">
                                        <select disabled className="text-start form-select" name='RF_RCA' id='RF_RCA' value={parseInt(FormData['RF_RCA'])} onChange={(e)=>{onChange(e)}} aria-label="Default select example">
                                            <option value="0" selected>Select Option</option>
                                            <option value="1">Yes</option>
                                            <option value="2">No</option>
                                        </select>  
                                    ...
                                    <div className="col-2">
                                        <select disabled className="text-start form-select" name='RF_Birth_Country' id='RF_Birth_Country' value={parseInt(FormData['RF_Birth_Country'])} onChange={(e)=>{onChange(e)}}  aria-label="Default select example">
                                            <option value="0" selected>Select Option</option>
                                            <option value="1">Afghanistan</option>
                                            <option value="2">Albania</option>
                                            <option value="3">Algeria</option>
