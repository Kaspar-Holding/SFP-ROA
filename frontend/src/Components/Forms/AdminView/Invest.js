    ...
    return(
      ...
      <div className="notification_container">
        <div className="alert alert-success fade show" style={{display: SuccessMessageVisibility}} role="alert">
          ...
          {/* <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button> */}
            ...
            <div className="row g-3 align-items-center">
                    ...
                    {/* <textarea maxLength={500}   id="provided_identity2" name="SFPSolutionFundsDetails" value={key.SFPSolutionFundsDetails}  onFocus={sica_onFocus} onBlur={sica_onBlur} className="form-control" placeholder="State the motivation" aria-describedby="" ></textarea> */}
                    <Editor
        ...
        {/* <textarea maxLength={500}   id="background_info8" className="form-control"  style={{height: '60px'}} 
            name='ItP_FundsReasons' value={key.ItP_FundsReasons}  
