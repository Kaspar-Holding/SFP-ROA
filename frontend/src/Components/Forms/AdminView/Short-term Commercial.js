...
const Short_term_Commercial= ({user}) => {
 {
    ...
    return(
                      ...
                      <div className="row">
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <input spellCheck="true" id="STIC_Quotation_Number"  value={FormData['STIC_Quotation_Number']}  name="STIC_Quotation_Number" className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                  <input spellCheck="true" id="STIC_Underwritten_By"  value={FormData['STIC_Underwritten_By']}  name="STIC_Underwritten_By" className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          {/* <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Branch_Name"  value={FormData['STIC_Branch_Name']}  name="STIC_Branch_Name" className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Branch_Number"  value={FormData['STIC_Branch_Number']}  name="STIC_Branch_Number" className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input type={"date"} spellCheck="true" id="STIC_Inception_Date"  value={FormData['STIC_Inception_Date']}  name="STIC_Inception_Date"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input type={"date"} spellCheck="true" id="STIC_Renewal_Date"  value={FormData['STIC_Renewal_Date']}  name="STIC_Renewal_Date" className="form-control" placeholder="Click or tap here to enter text." aria-describedby="" />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                 ...
                                 <div className="col-6">
                                    <input type="checkbox" checked={FormData["STIC_Payment_Method_Annual"] === 1 ? true : false} name="STIC_Payment_Method_Annual" />
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                 ...
                                 <div className="col-6">
                                    <input type="checkbox" checked={FormData["STIC_Payment_Method_Monthly"] === 1 ? true : false} name="STIC_Payment_Method_Monthly"/>
                                        <label for="vehicle1">Yes</label><br/>
                                  </div> 
                              </div>
                          </div>
                      ...
                      <div className="row">
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Business_Owner"  value={FormData['STIC_Business_Owner']}  name="STIC_Business_Owner"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Client_Id_Number"  value={FormData['STIC_Client_Id_Number']}  name="STIC_Client_Id_Number"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Company_Reg_Number"  value={FormData['STIC_Company_Reg_Number']}  name="STIC_Company_Reg_Number"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    {/* <input spellCheck="true" id="STIC_Branch_Number"  value={FormData['STIC_Branch_Number']}  name="STIC_Branch_Number"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} /> */}
                                  </div>
                              </div>
                          </div>
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Company_VAT_Number"  value={FormData['STIC_Company_VAT_Number']}  name="STIC_Company_VAT_Number"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Postal_Address"  value={FormData['STIC_Postal_Address']}  name="STIC_Postal_Address"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Risk_Address"  value={FormData['STIC_Risk_Address']}  name="STIC_Risk_Address"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Contact_Person"  value={FormData['STIC_Contact_Person']}  name="STIC_Contact_Person"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_TelePhone_Number"  value={FormData['STIC_TelePhone_Number']}  name="STIC_TelePhone_Number"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Fax_Number"  value={FormData['STIC_Fax_Number']}  name="STIC_Fax_Number"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_CellPhone_Number"  value={FormData['STIC_CellPhone_Number']}  name="STIC_CellPhone_Number"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Email"  value={FormData['STIC_Email']}  name="STIC_Email"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        ...
                        <hr/>
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                    <input spellCheck="true" id="STIC_Business_Description"  value={FormData['STIC_Business_Description']}  name="STIC_Business_Description"  className="form-control" placeholder="Click or tap here to enter text."  aria-describedby="" style={{width:"800px"}} />
                                  </div>
                              </div>
                          </div>
                        </div>
                        ...
                        <div className="col-6" style={{paddingBottom: "0.5%"}}>
                          ...
                          <div className="col-6" style={{paddingBottom: "0.5%"}}>
                              <div className="row g-3 align-items-center">
                                ...
                                <div className="col-4">
                                  {/* <input spellCheck="true" id="STIC_Applicable_Option"  value={FormData['STIC_Applicable_Option']}  name="STIC_Applicable_Option"  className="form-control" placeholder=""  aria-describedby="" style={{width:"600px",height:"100px"}} /> */}
                                  <Editor
                            ...
                            <div className="row g-3 align-items-center">
                                <div className="col-6">
                                  ...
                                  <div className="col-6">
                                      <div className="row">
                                          <div className="row col-2 align-items-center">
                                              <div className="col-2">
                                                  <input className="form-check-input" checked={FormData['STIC_General_Cancelled'] == 1 ? true : false}  type="radio" value="1" id="STIC_General_Cancelled" name="STIC_General_Cancelled" />
                                              </div>
                                              <div className="col-2">
                                          ...
                                          <div className="row col-2 align-items-center">
                                              <div className="col-2">
                                                  <input className="form-check-input" checked={FormData['STIC_General_Cancelled'] == 0 ? true : false}  type="radio" value="0" id="STIC_General_Cancelled" name="STIC_General_Cancelled" />
                                              </div>
                                              <div className="col-2">
                                                  <label className="form-check-label" htmlFor="STIC_General_Cancelled" >
                                                      No
                                  ...
                                  <div className="col-11" id="letter_of_introduction_2">
                                      ...
                                      {/* <textarea id="STIC_General_Cancelled_Detail"  value={FormData['STIC_General_Cancelled_Detail']}  name="STIC_General_Cancelled_Detail"  onFocus={letter_of_introduction_onFocus} onBlur={letter_of_introduction_onBlur} className="form-control" placeholder="If 'Yes', provide details:" aria-describedby="" ></textarea> */}
                                      <Editor
                            ...
                            <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
                                <div className="row">
                                    <div className="col-6" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            <div className="col-6">
                                                <input spellCheck="true" id="STIC_General_LossType"  value={FormData['STIC_General_LossType']}  name="STIC_General_LossType"  className="form-control" placeholder="Type of loss"  aria-describedby="" style={{width:"150px"}} />
                                            </div>
                                            
                                            <div className="col-6">
                                                <input spellCheck="true" id="STIC_General_Year"  value={FormData['STIC_General_Year']}  name="STIC_General_Year"  className="form-control" placeholder="Year"  aria-describedby="" style={{width:"150px"}} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-6" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            <div className="col-6">
                                                <input spellCheck="true" id="STIC_General_Amount"  value={FormData['STIC_General_Amount']}  name="STIC_General_Amount"  className="form-control" placeholder="0.00"  aria-describedby="" style={{width:"150px"}} />
                                            </div>
                                            
                                            <div className="col-6">
                                                <input spellCheck="true" id="STIC_General_Insurer"  value={FormData['STIC_General_Insurer']}  name="STIC_General_Insurer"  className="form-control" placeholder="Insurer"  aria-describedby="" style={{width:"150px"}} />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="row g-3 align-items-center">
                                  ...
                                  <div className="col-6">
                                      <div className="row">
                                          <div className="row col-2 align-items-center">
                                              <div className="col-2">
                                                  <input className="form-check-input" type="radio" value="1" checked={FormData['STIC_Replacement_Advise'] == 1 ? true : false} id="STIC_Replacement_Advise" name="STIC_Replacement_Advise" />
                                              </div>
                                              <div className="col-2">
                                          ...
                                          <div className="row col-2 align-items-center">
                                              <div className="col-2">
                                                  <input className="form-check-input" type="radio" value="0" checked={FormData['STIC_Replacement_Advise'] == 0 ? true : false} id="STIC_Replacement_Advise" name="STIC_Replacement_Advise" />
                                              </div>
                                              <div className="col-2">
                                                  <label className="form-check-label" htmlFor="provided_identity_radio_btn" >
                                                      No
                                  ...
                                  <div className="col-11" id="provided_identity_2" >
                                    <p>If yes,answer the following:</p>
                                      ...
                                      {/* <textarea  id="STIC_Replacement_Purpose"  value={FormData['STIC_Replacement_Purpose']}  name="STIC_Replacement_Purpose"  onFocus={STIC_Replacement_Purpose_onFocus} onBlur={STIC_Replacement_Purpose_onBlur} className="form-control" placeholder="Click or tap here to enter text" aria-describedby="" ></textarea> */}
                                      <Editor
                                      ...
                                      {/* <textarea  id="STIC_Replacement_Reason"  value={FormData['STIC_Replacement_Reason']}  name="STIC_Replacement_Reason"  onFocus={STIC_Replacement_Reason_onFocus} onBlur={STIC_Replacement_Reason_onBlur} className="form-control" placeholder="Click or tap here to enter text" aria-describedby="" ></textarea> */}
                                      <Editor
                                      ...
                                      {/* <textarea  id="STIC_Replacement_Suppliers"  value={FormData['STIC_Replacement_Suppliers']}  name="STIC_Replacement_Suppliers"  onFocus={STIC_Replacement_Suppliers_onFocus} onBlur={STIC_Replacement_Suppliers_onBlur} className="form-control" placeholder="Click or tap here to enter text" aria-describedby="" ></textarea> */}
                                      <Editor
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-16" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            ...
                                            <div className="col-4">
                                                <input spellCheck="true" id="STIC_Fin_FnC_Existing"  value={FormData['STIC_Fin_FnC_Existing']}  name="STIC_Fin_FnC_Existing"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>

                                            <div className="col-4">
                                            <input spellCheck="true" id="STIC_Fin_FnC_Replacement"  value={FormData['STIC_Fin_FnC_Replacement']}  name="STIC_Fin_FnC_Replacement"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-16" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            ...
                                            <div className="col-4">
                                                <input spellCheck="true" id="STIC_Fin_STnC_Existing"  value={FormData['STIC_Fin_STnC_Existing']}  name="STIC_Fin_STnC_Existing"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>

                                            <div className="col-4">
                                            <input spellCheck="true" id="STIC_Fin_STnC_Replacement"  value={FormData['STIC_Fin_STnC_Replacement']}  name="STIC_Fin_STnC_Replacement"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-16" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            ...
                                            <div className="col-4">
                                                <input spellCheck="true" id="STIC_Fin_ImpOnPre_Existing"  value={FormData['STIC_Fin_ImpOnPre_Existing']}  name="STIC_Fin_ImpOnPre_Existing"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>

                                            <div className="col-4">
                                            <input spellCheck="true" id="STIC_Fin_ImpOnPre_Replacement"  value={FormData['STIC_Fin_ImpOnPre_Replacement']}  name="STIC_Fin_ImpOnPre_Replacement"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-16" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            ...
                                            <div className="col-4">
                                                <input spellCheck="true" id="STIC_Fin_Excesses_Existing"  value={FormData['STIC_Fin_Excesses_Existing']}  name="STIC_Fin_Excesses_Existing"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>

                                            <div className="col-4">
                                            <input spellCheck="true" id="STIC_Fin_Excesses_Replacement"  value={FormData['STIC_Fin_Excesses_Replacement']}  name="STIC_Fin_Excesses_Replacement"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-16" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            ...
                                            <div className="col-4">
                                                <input spellCheck="true" id="STIC_Fin_VABen_Existing"  value={FormData['STIC_Fin_VABen_Existing']}  name="STIC_Fin_VABen_Existing"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>

                                            <div className="col-4">
                                            <input spellCheck="true" id="STIC_Fin_VABen_Replacement"  value={FormData['STIC_Fin_VABen_Replacement']}  name="STIC_Fin_VABen_Replacement"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-16" style={{paddingBottom: "0.5%"}}>
                                        <div className="row g-3 align-items-center">
                                            ...
                                            <div className="col-4">
                                                <input spellCheck="true" id="STIC_Fin_AdvisorComm_Existing"  value={FormData['STIC_Fin_AdvisorComm_Existing']}  name="STIC_Fin_AdvisorComm_Existing"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>

                                            <div className="col-4">
                                              <input spellCheck="true" id="STIC_Fin_AdvisorComm_Replacement"  value={FormData['STIC_Fin_AdvisorComm_Replacement']}  name="STIC_Fin_AdvisorComm_Replacement"  className="form-control" placeholder=""  aria-describedby="" style={{width:"200px"}} />
                                            </div>
                                        </div>
                                    </div>
                              ...
                              <tbody>
                                      ...
                                      <tr className="d-flex">
                                          ...
                                          <td className="col-2" align="center" style={{width:"260px"}}>
                                            ...
                                            <input spellCheck="true" id="STIC_ProdComp_Existing_Company"  value={FormData['STIC_ProdComp_Existing_Company']}  name="STIC_ProdComp_Existing_Company"  className="form-control" placeholder="Company"  aria-describedby="" />
                                            
                                          </td>
                                          <td className="col-2" align="center" style={{width:"260px"}}>
                                            <b>Replacement Product</b>
                                            <input spellCheck="true" id="STIC_ProdComp_Replacement_Company"  value={FormData['STIC_ProdComp_Replacement_Company']}  name="STIC_ProdComp_Replacement_Company"  className="form-control" placeholder="Company"  aria-describedby="" />
                                      ...
                                      <tr className="d-flex">
                                          ...
                                          <td className="col-6" style={{width:"590px"}}></td>
                                          <td className="col-2" align="center" style={{width:"260px"}}>
                                            <input spellCheck="true" id="STIC_ProdComp_Existing_Provider"  value={FormData['STIC_ProdComp_Existing_Provider']}  name="STIC_ProdComp_Existing_Provider"  className="form-control" placeholder="Provider"  aria-describedby="" />
                                            
                                          </td>
                                          <td className="col-2" align="center" style={{width:"260px"}}>
                                            <input spellCheck="true" id="STIC_ProdComp_Replacement_Provider"  value={FormData['STIC_ProdComp_Replacement_Provider']}  name="STIC_ProdComp_Replacement_Provider"  className="form-control" placeholder="Provider"  aria-describedby="" />
                                      ...
                                      <tr className="d-flex">
                                          ...
                                          <td className="col-6" style={{width:"590px"}}></td>
                                          <td className="col-2" align="center" style={{width:"260px"}}>
                                            <input spellCheck="true"  id="STIC_ProdComp_Existing_Product"  value={FormData['STIC_ProdComp_Existing_Product']}  name="STIC_ProdComp_Existing_Product"  className="form-control" placeholder="Product"  aria-describedby="" />
                                            
                                          </td>
                                          <td className="col-2" align="center" style={{width:"260px"}}>
                                            <input spellCheck="true"  id="STIC_ProdComp_Replacement_Product"  value={FormData['STIC_ProdComp_Replacement_Product']}  name="STIC_ProdComp_Replacement_Product"  className="form-control" placeholder="Product"  aria-describedby="" />
                                      ...
                                      <tr class="d-flex">
                                          ...
                                          <td class="col-2" style={{width:"130px"}}>
                                            <div className="input-group">
                                              <span className="input-group-text">R</span>
                                              <input type="number" spellCheck="true" id="STIC_ProdComp_CoverAmount44"  value={FormData["STIC_ProdComp_CoverAmount44"]}  name="STIC_ProdComp_CoverAmount44"  className="form-control" placeholder="0.00"  aria-describedby=""  />
                                            </div>
                                          </td>
                                          ...
                                          <td class="col-2" style={{width:"130px"}}>
                                            <div className="input-group">
                                              <span className="input-group-text">R</span>
                                              <input type="number" spellCheck="true" id="STIC_ProdComp_ExistP_Premium44"  value={FormData["STIC_ProdComp_ExistP_Premium44"]}  name="STIC_ProdComp_ExistP_Premium44"  className="form-control" placeholder="0.00"  aria-describedby=""  />
                                            </div>
                                          </td>
                                          ...
                                          <td class="col-2" style={{width:"130px"}}>
                                            <div className="input-group">
                                              <span className="input-group-text">R</span>
                                              <input type="number" spellCheck="true" id="STIC_ProdComp_ExistP_Excess44"  value={FormData["STIC_ProdComp_ExistP_Excess44"]}  name="STIC_ProdComp_ExistP_Excess44"  className="form-control" placeholder="0.00"  aria-describedby=""  />
                                            </div>
                                          </td>
                                          ...
                                          <td class="col-2" style={{width:"130px"}}>
                                            <div className="input-group">
                                              <span className="input-group-text">R</span>
                                              <input type="number" spellCheck="true" id="STIC_ProdComp_RecommP_Premium44"  value={FormData["STIC_ProdComp_RecommP_Premium44"]}  name="STIC_ProdComp_RecommP_Premium44"  className="form-control" placeholder="0.00"  aria-describedby=""  />
                                            </div>
                                          </td>
                                          ...
                                          <td class="col-2" style={{width:"130px"}}>
                                            <div className="input-group">
                                              <span className="input-group-text">R</span>
                                              <input type="number" spellCheck="true" id="STIC_ProdComp_RecommP_Excess44"  value={FormData["STIC_ProdComp_RecommP_Excess44"]}  name="STIC_ProdComp_RecommP_Excess44"  className="form-control" placeholder="0.00"  aria-describedby=""  />
                                            </div>
                                          </td>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_Fire_Limit"  value={FormData['STIC_Fire_Limit']}  name="STIC_Fire_Limit"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_Fire_ItemNumber"  value={FormData['STIC_Fire_ItemNumber']}  name="STIC_Fire_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_Fire_Premium"  value={FormData['STIC_Fire_Premium']}  name="STIC_Fire_Premium"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
              ...
              <div className="col-4">
               <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_Fire_PremNumber"  value={FormData['STIC_Fire_PremNumber']}  name="STIC_Fire_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
          </div>
      </div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_Buildings_Insured"  value={FormData['STIC_Buildings_Insured']}  name="STIC_Buildings_Insured"  className="form-control" placeholder="                    R .00"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                   ...
                                   <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_Rental_Insured"  value={FormData['STIC_Rental_Insured']}  name="STIC_Rental_Insured"  className="form-control" placeholder="                    R .00"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_Others_Insured"  value={FormData['STIC_Others_Insured']}  name="STIC_Others_Insured"  className="form-control" placeholder="                    R .00"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_Stocks_Insured"  value={FormData['STIC_Stocks_Insured']}  name="STIC_Stocks_Insured"  className="form-control" placeholder="                    R .00"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_Miscellaneous1_Insured"  value={FormData['STIC_Miscellaneous1_Insured']}  name="STIC_Miscellaneous1_Insured"  className="form-control" placeholder="                    R .00"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_Miscellaneous2_Insured"  value={FormData['STIC_Miscellaneous2_Insured']}  name="STIC_Miscellaneous2_Insured"  className="form-control" placeholder="                    R .00"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Earthquake_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_Earthquake_Insured" name="STIC_Earthquake_Insured" />
                                          </div>
                                          <div className="col-3">
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Earthquake_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_Earthquake_Insured" name="STIC_Earthquake_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Malicious_Damage_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_Malicious_Damage_Insured" name="STIC_Malicious_Damage_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Malicious_Damage_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_Malicious_Damage_Insured" name="STIC_Malicious_Damage_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Special_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_Special_Insured" name="STIC_Special_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Special_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_Special_Insured" name="STIC_Special_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_LeakFull_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_LeakFull_Insured" name="STIC_LeakFull_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_LeakFull_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_LeakFull_Insured" name="STIC_LeakFull_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_LeakFirst_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_LeakFirst_Insured" name="STIC_LeakFirst_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_LeakFirst_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_LeakFirst_Insured" name="STIC_LeakFirst_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_SnLLimited_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_SnLLimited_Insured" name="STIC_SnLLimited_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_SnLLimited_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_SnLLimited_Insured" name="STIC_SnLLimited_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_SnLComprehensive_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_SnLComprehensive_Insured" name="STIC_SnLComprehensive_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_SnLComprehensive_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_SnLComprehensive_Insured" name="STIC_SnLComprehensive_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_RnS_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_RnS_Insured" name="STIC_RnS_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_RnS_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_RnS_Insured" name="STIC_RnS_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_SDC_Insured'] == 1 ? true : false}  type="radio" value="1" id="STIC_SDC_Insured" name="STIC_SDC_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Monthly
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_SDC_Insured'] == 0 ? true : false}  type="radio" value="0" id="STIC_SDC_Insured" name="STIC_SDC_Insured" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Quarterly
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_BuildCombined_Limit"  value={FormData['STIC_BuildCombined_Limit']}  name="STIC_BuildCombined_Limit"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_BuildCombined_Premium"  value={FormData['STIC_BuildCombined_Premium']}  name="STIC_BuildCombined_Premium"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_BuildCombined_ItemNumber"  value={FormData['STIC_BuildCombined_ItemNumber']}  name="STIC_BuildCombined_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_BuildCombined_PremNumber"  value={FormData['STIC_BuildCombined_PremNumber']}  name="STIC_BuildCombined_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
          </div>
      </div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_BuildCombined_ColumnRef"  value={FormData['STIC_BuildCombined_ColumnRef']}  name="STIC_BuildCombined_ColumnRef"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <div className="input-group">
                                          <span className="input-group-text">R</span>
                                          <input spellCheck="true" id="STIC_BuildCombined_Sum"  value={FormData['STIC_BuildCombined_Sum']}  name="STIC_BuildCombined_Sum"  className="form-control" placeholder="0.00"  aria-describedby=""  />
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                            <input className="form-check-input" checked={FormData['STIC_BuildCombined_Construct'] == 1 ? true : false}  type="radio" value="1" id="STIC_BuildCombined_Construct" name="STIC_BuildCombined_Construct" />
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_BuildCombined_Construct'] == 0 ? true: false }  type="radio" value="0" id="STIC_BuildCombined_Construct" name="STIC_BuildCombined_Construct" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                          <input spellCheck="true" id="STIC_BuildCombined_Desc"  value={FormData['STIC_BuildCombined_Desc']}  name="STIC_BuildCombined_Desc"  className="form-control" placeholder="Click here to enter the text"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                    <hr/>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_RnS'] == 1 ? true : false}  type="radio" value="1" id="STIC_Extensions_RnS" name="STIC_Extensions_RnS" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_RnS'] == 0 ? true : false}  type="radio" value="0" id="STIC_Extensions_RnS" name="STIC_Extensions_RnS" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_Geysers'] == 1 ? true : false}  type="radio" value="1" id="STIC_Extensions_Geysers" name="STIC_Extensions_Geysers" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_Geysers'] == 0 ? true : false}  type="radio" value="0" id="STIC_Extensions_Geysers" name="STIC_Extensions_Geysers" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_SnL'] == 1 ? true : false}  type="radio" value="1" id="STIC_Extensions_SnL" name="STIC_Extensions_SnL" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_SnL'] == 0 ? true : false}  type="radio" value="0" id="STIC_Extensions_SnL" name="STIC_Extensions_SnL" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_PoA'] == 1 ? true : false}  type="radio" value="1" id="STIC_Extensions_PoA" name="STIC_Extensions_PoA" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_PoA'] == 0 ? true : false}  type="radio" value="0" id="STIC_Extensions_PoA" name="STIC_Extensions_PoA" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_IorE'] == 1 ? true : false}  type="radio" value="1" id="STIC_Extensions_IorE" name="STIC_Extensions_IorE" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_Extensions_IorE'] == 0 ? true : false}  type="radio" value="0" id="STIC_Extensions_IorE" name="STIC_Extensions_IorE" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_OC_Limit"  value={FormData['STIC_OC_Limit']}  name="STIC_OC_Limit"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
              ...
              <div className="col-4">
                <div className="input-group">
                  <span className="input-group-text">R</span>
                  <input spellCheck="true" id="STIC_OC_Premium"  value={FormData['STIC_OC_Premium']}  name="STIC_OC_Premium"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_OC_ItemNumber"  value={FormData['STIC_OC_ItemNumber']}  name="STIC_OC_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_OC_PremNumber"  value={FormData['STIC_OC_PremNumber']}  name="STIC_OC_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
    <hr/>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <div className="input-group">
                                          <span className="input-group-text">R</span>
                                          <input spellCheck="true" id="STIC_OC_Sum"  value={FormData['STIC_OC_Sum']}  name="STIC_OC_Sum"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="row col-4 align-items-center">
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_OC_Construct'] == 1 ? true : false}  type="radio" value="1" id="STIC_OC_Construct" name="STIC_OC_Construct" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  Yes
                                          ...
                                          <div className="col-3">
                                              <input className="form-check-input" checked={FormData['STIC_OC_Construct'] == 0 ? true : false}  type="radio" value="0" id="STIC_OC_Construct" name="STIC_OC_Construct" />
                                          </div>
                                          <div className="col-3">
                                              <label className="form-check-label"  >
                                                  No
                                  ...
                                  <div className="col-8" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_Desc"  value={FormData['STIC_OC_Desc']}  name="STIC_OC_Desc"  className="form-control" placeholder="Click here to enter the text"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                    <hr/>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_Doc_Sum"  value={FormData['STIC_OC_Doc_Sum']}  name="STIC_OC_Doc_Sum"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_Doc_Premium"  value={FormData['STIC_OC_Doc_Premium']}  name="STIC_OC_Doc_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_LLDoc_Sum"  value={FormData['STIC_OC_LLDoc_Sum']}  name="STIC_OC_LLDoc_Sum"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_LLDoc_Premium"  value={FormData['STIC_OC_LLDoc_Premium']}  name="STIC_OC_LLDoc_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_RnS_Sum"  value={FormData['STIC_OC_RnS_Sum']}  name="STIC_OC_RnS_Sum"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_RnS_Premium"  value={FormData['STIC_OC_RnS_Premium']}  name="STIC_OC_RnS_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_TheftF_Sum"  value={FormData['STIC_OC_TheftF_Sum']}  name="STIC_OC_TheftF_Sum"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_TheftF_Premium"  value={FormData['STIC_OC_TheftF_Premium']}  name="STIC_OC_TheftF_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_Theft_Sum"  value={FormData['STIC_OC_Theft_Sum']}  name="STIC_OC_Theft_Sum"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_Theft_Premium"  value={FormData['STIC_OC_Theft_Premium']}  name="STIC_OC_Theft_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        {/* <input spellCheck="true" id="STIC_OC_Total_Premium"  value={FormData['STIC_OC_Total_Premium']}  name="STIC_OC_Total_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} /> */}
                                      </div>
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_OC_Total_Premium"  value={FormData['STIC_OC_Total_Premium']}  name="STIC_OC_Total_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_BusInt_Limit"  value={FormData['STIC_BusInt_Limit']}  name="STIC_BusInt_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_BusInt_Premium"  value={FormData['STIC_BusInt_Premium']}  name="STIC_BusInt_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_BusInt_ItemNumber"  value={FormData['STIC_BusInt_ItemNumber']}  name="STIC_BusInt_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_BusInt_PremNumber"  value={FormData['STIC_BusInt_PremNumber']}  name="STIC_BusInt_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_BusInt_Basis"  value={FormData['STIC_BusInt_Basis']}  name="STIC_BusInt_Basis"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
                                  ...
                                  <div className="col-10" style={{paddingBottom: "0.5%"}}>
                                    <div className="row g-3 align-items-center">
                                      ...
                                      <div className="col-3">
                                        <input spellCheck="true" id="STIC_BusInt_Indemnity"  value={FormData['STIC_BusInt_Indemnity']}  name="STIC_BusInt_Indemnity"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"200px"}} />
                                      </div>
                                    </div>
                                  </div>
                                  <hr/>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type1'] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type1" name="STIC_BusInt_Type1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type1'] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type1" name="STIC_BusInt_Type1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type2'] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2" name="STIC_BusInt_Type2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type2'] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2" name="STIC_BusInt_Type2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type3"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type3" name="STIC_BusInt_Type3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type3"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type3" name="STIC_BusInt_Type3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type4"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type4" name="STIC_BusInt_Type4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type4"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type4" name="STIC_BusInt_Type4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type5"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type5" name="STIC_BusInt_Type5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type5"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type5" name="STIC_BusInt_Type5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type6"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type6" name="STIC_BusInt_Type6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type6"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type6" name="STIC_BusInt_Type6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type7"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type7" name="STIC_BusInt_Type7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type7"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type7" name="STIC_BusInt_Type7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type8"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type8" name="STIC_BusInt_Type8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type8"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type8" name="STIC_BusInt_Type8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="col-3">
          <input spellCheck="true" id="STIC_BusInt_Type9"  value={FormData['STIC_BusInt_Type9']}  name="STIC_BusInt_Type9"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
        </div>
      </td>
      <td>
      <input spellCheck="true" id="STIC_BusInt_Type9_1"  value={FormData['STIC_BusInt_Type9_1']}  name="STIC_BusInt_Type9_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <div className="col-3">
          <input spellCheck="true" id="STIC_BusInt_Type10"  value={FormData['STIC_BusInt_Type10']}  name="STIC_BusInt_Type10"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
        </div>
      </td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type11"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type11" name="STIC_BusInt_Type11" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type11"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type11" name="STIC_BusInt_Type11" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type11_1"  value={FormData['STIC_BusInt_Type11_1']}  name="STIC_BusInt_Type11_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type12"  value={FormData['STIC_BusInt_Type12']}  name="STIC_BusInt_Type12"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type13"  value={FormData['STIC_BusInt_Type13']}  name="STIC_BusInt_Type13"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type14"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type14" name="STIC_BusInt_Type14" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type14"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type14" name="STIC_BusInt_Type14" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type14_1"  value={FormData['STIC_BusInt_Type14_1']}  name="STIC_BusInt_Type14_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type15"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type15" name="STIC_BusInt_Type15" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type15"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type15" name="STIC_BusInt_Type15" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type15_1"  value={FormData['STIC_BusInt_Type15_1']}  name="STIC_BusInt_Type15_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type16"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type16" name="STIC_BusInt_Type16" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type16"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type16" name="STIC_BusInt_Type16" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type16_1"  value={FormData['STIC_BusInt_Type16_1']}  name="STIC_BusInt_Type16_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type17"  value={FormData['STIC_BusInt_Type17']}  name="STIC_BusInt_Type17"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Premises</td>
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type18"  value={FormData['STIC_BusInt_Type18']}  name="STIC_BusInt_Type18"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type19"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type19" name="STIC_BusInt_Type19" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type19"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type19" name="STIC_BusInt_Type19" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type19_1"  value={FormData['STIC_BusInt_Type19_1']}  name="STIC_BusInt_Type19_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type20"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type20" name="STIC_BusInt_Type20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type20"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type20" name="STIC_BusInt_Type20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type20_1"  value={FormData['STIC_BusInt_Type20_1']}  name="STIC_BusInt_Type20_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type21"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type21" name="STIC_BusInt_Type21" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type21"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type21" name="STIC_BusInt_Type21" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type21_1"  value={FormData['STIC_BusInt_Type21_1']}  name="STIC_BusInt_Type21_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type22"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type22" name="STIC_BusInt_Type22" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type22"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type22" name="STIC_BusInt_Type22" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type22_1"  value={FormData['STIC_BusInt_Type22_1']}  name="STIC_BusInt_Type22_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type23"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type23" name="STIC_BusInt_Type23" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type23"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type23" name="STIC_BusInt_Type23" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type23_1"  value={FormData['STIC_BusInt_Type23_1']}  name="STIC_BusInt_Type23_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_TotalPremium"  value={FormData['STIC_BusInt_TotalPremium']}  name="STIC_BusInt_TotalPremium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <input spellCheck="true" id="STIC_BusInt_Comments"  value={FormData['STIC_BusInt_Comments']}  name="STIC_BusInt_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
       ...
       <div className="row">
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_BusInt_PremisesNumber"  value={FormData['STIC_BusInt_PremisesNumber']}  name="STIC_BusInt_PremisesNumber"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
          </div>
          <hr/>
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_BusInt_IndemPer"  value={FormData['STIC_BusInt_IndemPer']}  name="STIC_BusInt_IndemPer"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"200px"}} />
  ...
  <tbody>
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type2_1'] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_1" name="STIC_BusInt_Type2_1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type2_1'] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_1" name="STIC_BusInt_Type2_1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type2_2'] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_2" name="STIC_BusInt_Type2_2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData['STIC_BusInt_Type2_2'] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_2" name="STIC_BusInt_Type2_2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_3"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_3" name="STIC_BusInt_Type2_3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_3"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_3" name="STIC_BusInt_Type2_3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_4"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_4" name="STIC_BusInt_Type2_4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_4"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_4" name="STIC_BusInt_Type2_4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_5"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_5" name="STIC_BusInt_Type2_5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_5"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_5" name="STIC_BusInt_Type2_5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_6"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_6" name="STIC_BusInt_Type2_6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_6"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_6" name="STIC_BusInt_Type2_6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_7"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_7" name="STIC_BusInt_Type2_7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_7"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_7" name="STIC_BusInt_Type2_7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_8"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_8" name="STIC_BusInt_Type2_8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_8"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_8" name="STIC_BusInt_Type2_8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="col-3">
          <input spellCheck="true" id="STIC_BusInt_Type2_9"  value={FormData['STIC_BusInt_Type2_9']}  name="STIC_BusInt_Type2_9"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
        </div>
      </td>
      <td>
      <input spellCheck="true" id="STIC_BusInt_Type2_9_1"  value={FormData['STIC_BusInt_Type2_9_1']}  name="STIC_BusInt_Type2_9_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <div className="col-3">
          <input spellCheck="true" id="STIC_BusInt_Type2_10"  value={FormData['STIC_BusInt_Type2_10']}  name="STIC_BusInt_Type2_10"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
        </div>
      </td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_11"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_11" name="STIC_BusInt_Type2_11" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_11"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_11" name="STIC_BusInt_Type2_11" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_11_1"  value={FormData['STIC_BusInt_Type2_11_1']}  name="STIC_BusInt_Type2_11_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Supplier</td>
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_12"  value={FormData['STIC_BusInt_Type2_12']}  name="STIC_BusInt_Type2_12"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Premises</td>
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_13"  value={FormData['STIC_BusInt_Type2_13']}  name="STIC_BusInt_Type2_13"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_14"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_14" name="STIC_BusInt_Type2_14" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_14"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_14" name="STIC_BusInt_Type2_14" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_14_1"  value={FormData['STIC_BusInt_Type2_14_1']}  name="STIC_BusInt_Type2_14_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_15"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_15" name="STIC_BusInt_Type2_15" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_15"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_15" name="STIC_BusInt_Type2_15" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_15_1"  value={FormData['STIC_BusInt_Type2_15_1']}  name="STIC_BusInt_Type2_15_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_16"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_16" name="STIC_BusInt_Type2_16" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_16"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_16" name="STIC_BusInt_Type2_16" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_16_1"  value={FormData['STIC_BusInt_Type2_16_1']}  name="STIC_BusInt_Type2_16_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client</td>
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_17"  value={FormData['STIC_BusInt_Type2_17']}  name="STIC_BusInt_Type2_17"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Premises</td>
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_18"  value={FormData['STIC_BusInt_Type2_18']}  name="STIC_BusInt_Type2_18"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_19"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_19" name="STIC_BusInt_Type2_19" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_19"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_19" name="STIC_BusInt_Type2_19" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_19_1"  value={FormData['STIC_BusInt_Type2_19_1']}  name="STIC_BusInt_Type2_19_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_20"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_20" name="STIC_BusInt_Type2_20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_20"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_20" name="STIC_BusInt_Type2_20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_20_1"  value={FormData['STIC_BusInt_Type2_20_1']}  name="STIC_BusInt_Type2_20_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_21"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_21" name="STIC_BusInt_Type2_21" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_21"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_21" name="STIC_BusInt_Type2_21" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_21_1"  value={FormData['STIC_BusInt_Type2_21_1']}  name="STIC_BusInt_Type2_21_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_22"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_22" name="STIC_BusInt_Type2_22" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_22"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_22" name="STIC_BusInt_Type2_22" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_22_1"  value={FormData['STIC_BusInt_Type2_22_1']}  name="STIC_BusInt_Type2_22_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_23"] == 1 ? true : false}  type="radio" value="1" id="STIC_BusInt_Type2_23" name="STIC_BusInt_Type2_23" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_BusInt_Type2_23"] == 0 ? true : false}  type="radio" value="0" id="STIC_BusInt_Type2_23" name="STIC_BusInt_Type2_23" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt_Type2_23_1"  value={FormData['STIC_BusInt_Type2_23_1']}  name="STIC_BusInt_Type2_23_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_BusInt2_TotalPremium"  value={FormData['STIC_BusInt2_TotalPremium']}  name="STIC_BusInt2_TotalPremium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
      </td>
      <td></td>
      <td></td>
    </tr>
  ...
  <br/>
    <div><b>Comments</b></div>
    <input spellCheck="true" id="STIC_BusInt2_Comments"  value={FormData['STIC_BusInt2_Comments']}  name="STIC_BusInt2_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec5_Limit"  value={FormData['STIC_Sec5_Limit']}  name="STIC_Sec5_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec5_Premium"  value={FormData['STIC_Sec5_Premium']}  name="STIC_Sec5_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec5_ItemNumber"  value={FormData['STIC_Sec5_ItemNumber']}  name="STIC_Sec5_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec5_PremNumber"  value={FormData['STIC_Sec5_PremNumber']}  name="STIC_Sec5_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>                               
       ...
       <div className="row">
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_Sec5_1"  value={FormData['STIC_Sec5_1']}  name="STIC_Sec5_1"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
          </div>
          <hr/>
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_Sec5_2"  value={FormData['STIC_Sec5_2']}  name="STIC_Sec5_2"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"200px"}} />
  ...
  <tbody>
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec5_Extension_1" name="STIC_Sec5_Extension_1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec5_Extension_1" name="STIC_Sec5_Extension_1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec5_Extension_2" name="STIC_Sec5_Extension_2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec5_Extension_2" name="STIC_Sec5_Extension_2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec5_Extension_3" name="STIC_Sec5_Extension_3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec5_Extension_3" name="STIC_Sec5_Extension_3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_4"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec5_Extension_4" name="STIC_Sec5_Extension_4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_4"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec5_Extension_4" name="STIC_Sec5_Extension_4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_5"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec5_Extension_5" name="STIC_Sec5_Extension_5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec5_Extension_5"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec5_Extension_5" name="STIC_Sec5_Extension_5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
      <input spellCheck="true" id="STIC_Sec5_AnnualPremium"  value={FormData['STIC_Sec5_AnnualPremium']}  name="STIC_Sec5_AnnualPremium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"150px"}} />
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec5_Comments"  value={FormData['STIC_Sec5_Comments']}  name="STIC_Sec5_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec6_Limit"  value={FormData['STIC_Sec6_Limit']}  name="STIC_Sec6_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec6_Premium"  value={FormData['STIC_Sec6_Premium']}  name="STIC_Sec6_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec6_ItemNumber"  value={FormData['STIC_Sec6_ItemNumber']}  name="STIC_Sec6_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec6_PremNumber"  value={FormData['STIC_Sec6_PremNumber']}  name="STIC_Sec6_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div> 
       ...
       <div className="row">
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_Sec6_1"  value={FormData['STIC_Sec6_1']}  name="STIC_Sec6_1"  className="form-control" placeholder=" R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
          </div>
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_Sec6_2"  value={FormData['STIC_Sec6_2']}  name="STIC_Sec6_2"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
          </div>
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_Sec6_3"  value={FormData['STIC_Sec6_3']}  name="STIC_Sec6_3"  className="form-control" placeholder=" R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
          </div>
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_Sec6_4"  value={FormData['STIC_Sec6_4']}  name="STIC_Sec6_4"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
          </div>
          ...
          <div className="col-10" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
              ...
              <div className="col-3">
                <input spellCheck="true" id="STIC_Sec6_5"  value={FormData['STIC_Sec6_5']}  name="STIC_Sec6_5"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
          </div>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec6_Comments"  value={FormData['STIC_Sec6_Comments']}  name="STIC_Sec6_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec7_Limit"  value={FormData['STIC_Sec7_Limit']}  name="STIC_Sec7_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec7_Premium"  value={FormData['STIC_Sec7_Premium']}  name="STIC_Sec7_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec7_ItemNumber"  value={FormData['STIC_Sec7_ItemNumber']}  name="STIC_Sec7_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec7_PremNumber"  value={FormData['STIC_Sec7_PremNumber']}  name="STIC_Sec7_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>                                  
  ...
  <tbody>
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec7_1"  value={FormData['STIC_Sec7_1']}  name="STIC_Sec7_1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium </td>

      <td>
        <input spellCheck="true" id="STIC_Sec7_2"  value={FormData['STIC_Sec7_2']}  name="STIC_Sec7_2"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec7_3" name="STIC_Sec7_3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec7_3" name="STIC_Sec7_3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_4"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec7_4" name="STIC_Sec7_4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_4"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec7_4" name="STIC_Sec7_4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
          <input spellCheck="true" id="STIC_Sec7_5"  value={FormData['STIC_Sec7_5']}  name="STIC_Sec7_5"  className="form-control" placeholder="Occupation Description:"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec7_6"  value={FormData['STIC_Sec7_6']}  name="STIC_Sec7_6"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold',fontcolor:"grey"}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec7_7"  value={FormData['STIC_Sec7_7']}  name="STIC_Sec7_7"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec7_8"  value={FormData['STIC_Sec7_8']}  name="STIC_Sec7_8"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold',fontcolor:"grey"}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec7_9"  value={FormData['STIC_Sec7_9']}  name="STIC_Sec7_9"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
    ...
    {/* <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Branch_Number"  value={FormData['STIC_Branch_Number']}  name="STIC_Branch_Number"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
...
<br/>
  ...
  <tbody>
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_Extension_Included1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec7_Extension_Included1" name="STIC_Sec7_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_Extension_Included1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec7_Extension_Included1" name="STIC_Sec7_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td> 
        <input spellCheck="true" id="STIC_Sec7_Extension_Limit1"  value={FormData['STIC_Sec7_Extension_Limit1']}  name="STIC_Sec7_Extension_Limit1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td>
      <input spellCheck="true" id="STIC_Sec7_Extension_Premium1"  value={FormData['STIC_Sec7_Extension_Premium1']}  name="STIC_Sec7_Extension_Premium1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_Extension_Included2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec7_Extension_Included2" name="STIC_Sec7_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_Extension_Included2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec7_Extension_Included2" name="STIC_Sec7_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td> 
        <input spellCheck="true" id="STIC_Sec7_Extension_Limit2"  value={FormData['STIC_Sec7_Extension_Limit2']}  name="STIC_Sec7_Extension_Limit2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td>
      <input spellCheck="true" id="STIC_Sec7_Extension_Premium2"  value={FormData['STIC_Sec7_Extension_Premium2']}  name="STIC_Sec7_Extension_Premium2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_Extension_Included3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec7_Extension_Included3" name="STIC_Sec7_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec7_Extension_Included3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec7_Extension_Included3" name="STIC_Sec7_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td> 
        <input spellCheck="true" id="STIC_Sec7_Extension_Limit3"  value={FormData['STIC_Sec7_Extension_Limit3']}  name="STIC_Sec7_Extension_Limit3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td>
      <input spellCheck="true" id="STIC_Sec7_Extension_Premium3"  value={FormData['STIC_Sec7_Extension_Premium3']}  name="STIC_Sec7_Extension_Premium3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
      <input spellCheck="true"  id="STIC_Sec7_AnnualPremium"  value={FormData['STIC_Sec7_AnnualPremium']}  name="STIC_Sec7_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td></td>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec7_Comments"  value={FormData['STIC_Sec7_Comments']}  name="STIC_Sec7_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className='row' style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec8_Limit"  value={FormData['STIC_Sec8_Limit']}  name="STIC_Sec8_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec8_Premium"  value={FormData['STIC_Sec8_Premium']}  name="STIC_Sec8_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec8_ItemNumber"  value={FormData['STIC_Sec8_ItemNumber']}  name="STIC_Sec8_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec8_PremNumber"  value={FormData['STIC_Sec8_PremNumber']}  name="STIC_Sec8_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Sum insured: </td>
      <td>
        <input spellCheck="true"   id="STIC_Sec8_1"  value={FormData['STIC_Sec8_1']}  name="STIC_Sec8_1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">
        {/* Premium:  */}
      </td>
      <td>
      {/* <input spellCheck="true" id="STIC_Sec8_PremNumber"  value={FormData['STIC_Sec8_PremNumber']}  name="STIC_Sec8_PremNumber" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> */}
      </td>
      <td></td>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
          <div className="col-3">
              <input className="form-check-input" checked={FormData["STIC_Sec8_Extension_Included1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec8_Extension_Included1" name="STIC_Sec8_Extension_Included1" />
          </div>
          <div className="col-3">
              <label className="form-check-label"  >
                  Yes
          ...
          <div className="col-3">
              <input className="form-check-input" checked={FormData["STIC_Sec8_Extension_Included1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec8_Extension_Included1" name="STIC_Sec8_Extension_Included1" />
          </div>
          <div className="col-3">
              <label className="form-check-label"  >
                  No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
          <div className="col-3">
              <input className="form-check-input" checked={FormData["STIC_Sec8_Extension_Included2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec8_Extension_Included2" name="STIC_Sec8_Extension_Included2" />
          </div>
          <div className="col-3">
              <label className="form-check-label"  >
                  Yes
          ...
          <div className="col-3">
              <input className="form-check-input" checked={FormData["STIC_Sec8_Extension_Included2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec8_Extension_Included2" name="STIC_Sec8_Extension_Included2" />
          </div>
          <div className="col-3">
              <label className="form-check-label"  >
                  No
    ...
    <tr>
      ...
      <td> 
      <input spellCheck="true"  id="STIC_Sec8_AnnualPremium"  value={FormData['STIC_Sec8_AnnualPremium']}  name="STIC_Sec8_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
      </td>
      <td>
      </td>
      <td></td>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec8_Comments"  value={FormData['STIC_Sec8_Comments']}  name="STIC_Sec8_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className='row' style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec9_Limit"  value={FormData['STIC_Sec9_Limit']}  name="STIC_Sec9_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec9_Premium"  value={FormData['STIC_Sec9_Premium']}  name="STIC_Sec9_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec9_ItemNumber"  value={FormData['STIC_Sec9_ItemNumber']}  name="STIC_Sec9_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec9_PremNumber"  value={FormData['STIC_Sec9_PremNumber']}  name="STIC_Sec9_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_1"  value={FormData['STIC_Sec9_1']}  name="STIC_Sec9_1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_2"  value={FormData['STIC_Sec9_2']}  name="STIC_Sec9_2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_3"  value={FormData['STIC_Sec9_3']}  name="STIC_Sec9_3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td>
      </td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_4"  value={FormData['STIC_Sec9_4']}  name="STIC_Sec9_4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td>
      </td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Sum insured:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_5"  value={FormData['STIC_Sec9_5']}  name="STIC_Sec9_5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_6"  value={FormData['STIC_Sec9_6']}  name="STIC_Sec9_6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec9_Extension_Included1" name="STIC_Sec9_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec9_Extension_Included1" name="STIC_Sec9_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Limit1"  value={FormData['STIC_Sec9_Extension_Limit1']}  name="STIC_Sec9_Extension_Limit1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Premium1"  value={FormData['STIC_Sec9_Extension_Premium1']}  name="STIC_Sec9_Extension_Premium1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec9_Extension_Included2" name="STIC_Sec9_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec9_Extension_Included2" name="STIC_Sec9_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Limit2"  value={FormData['STIC_Sec9_Extension_Limit2']}  name="STIC_Sec9_Extension_Limit2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Premium2"  value={FormData['STIC_Sec9_Extension_Premium2']}  name="STIC_Sec9_Extension_Premium2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec9_Extension_Included3" name="STIC_Sec9_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec9_Extension_Included3" name="STIC_Sec9_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Limit3"  value={FormData['STIC_Sec9_Extension_Limit3']}  name="STIC_Sec9_Extension_Limit3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Premium3"  value={FormData['STIC_Sec9_Extension_Premium3']}  name="STIC_Sec9_Extension_Premium3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included4"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec9_Extension_Included4" name="STIC_Sec9_Extension_Included4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included4"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec9_Extension_Included4" name="STIC_Sec9_Extension_Included4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Limit4"  value={FormData['STIC_Sec9_Extension_Limit4']}  name="STIC_Sec9_Extension_Limit4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Premium4"  value={FormData['STIC_Sec9_Extension_Premium4']}  name="STIC_Sec9_Extension_Premium4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included5"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec9_Extension_Included5" name="STIC_Sec9_Extension_Included5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included5"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec9_Extension_Included5" name="STIC_Sec9_Extension_Included5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Limit5"  value={FormData['STIC_Sec9_Extension_Limit5']}  name="STIC_Sec9_Extension_Limit5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Premium5"  value={FormData['STIC_Sec9_Extension_Premium5']}  name="STIC_Sec9_Extension_Premium5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included6"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec9_Extension_Included6" name="STIC_Sec9_Extension_Included6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec9_Extension_Included6"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec9_Extension_Included6" name="STIC_Sec9_Extension_Included6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Limit6"  value={FormData['STIC_Sec9_Extension_Limit6']}  name="STIC_Sec9_Extension_Limit6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec9_Extension_Premium6"  value={FormData['STIC_Sec9_Extension_Premium6']}  name="STIC_Sec9_Extension_Premium6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec9_AnnualPremium"  value={FormData['STIC_Sec9_AnnualPremium']}  name="STIC_Sec9_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec9_Comments"  value={FormData['STIC_Sec9_Comments']}  name="STIC_Sec9_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className='row' style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec10_Limit"  value={FormData['STIC_Sec10_Limit']}  name="STIC_Sec10_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec10_Premium"  value={FormData['STIC_Sec10_Premium']}  name="STIC_Sec10_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec10_ItemNumber"  value={FormData['STIC_Sec10_ItemNumber']}  name="STIC_Sec10_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec10_PremNumber"  value={FormData['STIC_Sec10_PremNumber']}  name="STIC_Sec10_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_1"  value={FormData['STIC_Sec10_1']}  name="STIC_Sec10_1" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_2"  value={FormData['STIC_Sec10_2']}  name="STIC_Sec10_2" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_3"  value={FormData['STIC_Sec10_3']}  name="STIC_Sec10_3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_4"  value={FormData['STIC_Sec10_4']}  name="STIC_Sec10_4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec10_5"  value={FormData['STIC_Sec10_5']}  name="STIC_Sec10_5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_6"  value={FormData['STIC_Sec10_6']}  name="STIC_Sec10_6" className="form-control" placeholder="0.00"  aria-describedby=""/> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec10_Extension_Included1" name="STIC_Sec10_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec10_Extension_Included1" name="STIC_Sec10_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_Extension_Limit1"  value={FormData['STIC_Sec10_Extension_Limit1']}  name="STIC_Sec10_Extension_Limit1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec10_Extension_Premium1"  value={FormData['STIC_Sec10_Extension_Premium1']}  name="STIC_Sec10_Extension_Premium1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec10_Extension_Included2" name="STIC_Sec10_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec10_Extension_Included2" name="STIC_Sec10_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_Extension_Limit2"  value={FormData['STIC_Sec10_Extension_Limit2']}  name="STIC_Sec10_Extension_Limit2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec10_Extension_Premium2"  value={FormData['STIC_Sec10_Extension_Premium2']}  name="STIC_Sec10_Extension_Premium2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec10_Extension_Included3" name="STIC_Sec10_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec10_Extension_Included3" name="STIC_Sec10_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec10_Extension_Limit4"  value={FormData['STIC_Sec10_Extension_Limit4']}  name="STIC_Sec10_Extension_Limit4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec10_Extension_Premium4"  value={FormData['STIC_Sec10_Extension_Premium4']}  name="STIC_Sec10_Extension_Premium4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included4"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec10_Extension_Included4" name="STIC_Sec10_Extension_Included4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec10_Extension_Included4"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec10_Extension_Included4" name="STIC_Sec10_Extension_Included4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td></td>
      <td>
        <input spellCheck="true" id="STIC_Sec10_AnnualPremium"  value={FormData['STIC_Sec10_AnnualPremium']}  name="STIC_Sec10_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec10_Comments"  value={FormData['STIC_Sec10_Comments']}  name="STIC_Sec10_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className='row' style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec11_Limit"  value={FormData['STIC_Sec11_Limit']}  name="STIC_Sec11_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec11_Premium"  value={FormData['STIC_Sec11_Premium']}  name="STIC_Sec11_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec11_ItemNumber"  value={FormData['STIC_Sec11_ItemNumber']}  name="STIC_Sec11_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec11_PremNumber"  value={FormData['STIC_Sec11_PremNumber']}  name="STIC_Sec11_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec11_1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec11_1" name="STIC_Sec11_1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec11_1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec11_1" name="STIC_Sec11_1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec11_2"  value={FormData['STIC_Sec11_2']}  name="STIC_Sec11_2" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec11_3"  value={FormData['STIC_Sec11_3']}  name="STIC_Sec11_3" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec11_4"  value={FormData['STIC_Sec11_4']}  name="STIC_Sec11_4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Article Description:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec11_5"  value={FormData['STIC_Sec11_5']}  name="STIC_Sec11_5" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec11_6"  value={FormData['STIC_Sec11_6']}  name="STIC_Sec11_6" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Serial Number:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec11_7"  value={FormData['STIC_Sec11_7']}  name="STIC_Sec11_7" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Sum insured:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec11_8"  value={FormData['STIC_Sec11_8']}  name="STIC_Sec11_8" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec11_9"  value={FormData['STIC_Sec11_9']}  name="STIC_Sec11_9" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec11_10"  value={FormData['STIC_Sec11_10']}  name="STIC_Sec11_10" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td></td>
      <td>
        <input spellCheck="true" id="STIC_Sec11_AnnualPremium"  value={FormData['STIC_Sec11_AnnualPremium']}  name="STIC_Sec11_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec11_Comments"  value={FormData['STIC_Sec11_Comments']}  name="STIC_Sec11_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className='row' style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec12_Limit"  value={FormData['STIC_Sec12_Limit']}  name="STIC_Sec12_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec12_Premium"  value={FormData['STIC_Sec12_Premium']}  name="STIC_Sec12_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec12_ItemNumber"  value={FormData['STIC_Sec12_ItemNumber']}  name="STIC_Sec12_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec12_PremNumber"  value={FormData['STIC_Sec12_PremNumber']}  name="STIC_Sec12_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec12_1"  value={FormData['STIC_Sec12_1']}  name="STIC_Sec12_1" className="form-control" placeholder="0.00"  aria-describedby=""/> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Same risk:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec12_2"  value={FormData['STIC_Sec12_2']}  name="STIC_Sec12_2" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec12_3"  value={FormData['STIC_Sec12_3']}  name="STIC_Sec12_3" className="form-control" placeholder="0.00"  aria-describedby=""/> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Sum insured:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec12_4"  value={FormData['STIC_Sec12_4']}  name="STIC_Sec12_4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec12_5"  value={FormData['STIC_Sec12_5']}  name="STIC_Sec12_5" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">First amount payable:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec12_6"  value={FormData['STIC_Sec12_6']}  name="STIC_Sec12_6" className="form-control" placeholder="0.00"  aria-describedby=""/> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec12_Extension_Included1" name="STIC_Sec12_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec12_Extension_Included1" name="STIC_Sec12_Extension_Included1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec12_Extension_Included2" name="STIC_Sec12_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec12_Extension_Included2" name="STIC_Sec12_Extension_Included2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec12_Extension_Included3" name="STIC_Sec12_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec12_Extension_Included3" name="STIC_Sec12_Extension_Included3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included4"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec12_Extension_Included4" name="STIC_Sec12_Extension_Included4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included4"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec12_Extension_Included4" name="STIC_Sec12_Extension_Included4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included5"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec12_Extension_Included5" name="STIC_Sec12_Extension_Included5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec12_Extension_Included5"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec12_Extension_Included5" name="STIC_Sec12_Extension_Included5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left"><b>Total annual premium for item</b>:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec12_AnnualPremium"  value={FormData['STIC_Sec12_AnnualPremium']}  name="STIC_Sec12_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec12_Comments"  value={FormData['STIC_Sec12_Comments']}  name="STIC_Sec12_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec13_Limit"  value={FormData['STIC_Sec13_Limit']}  name="STIC_Sec13_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec13_Premium"  value={FormData['STIC_Sec13_Premium']}  name="STIC_Sec13_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec13_ItemNumber"  value={FormData['STIC_Sec13_ItemNumber']}  name="STIC_Sec13_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec13_PremNumber"  value={FormData['STIC_Sec13_PremNumber']}  name="STIC_Sec13_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_1"  value={FormData['STIC_Sec13_1']}  name="STIC_Sec13_1" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_2"  value={FormData['STIC_Sec13_2']}  name="STIC_Sec13_2" type="date" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_3"  value={FormData['STIC_Sec13_3']}  name="STIC_Sec13_3"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_4"  value={FormData['STIC_Sec13_4']}  name="STIC_Sec13_4"  className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_5"  value={FormData['STIC_Sec13_5']}  name="STIC_Sec13_5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_6"  value={FormData['STIC_Sec13_6']}  name="STIC_Sec13_6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_7"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_7" name="STIC_Sec13_7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_7"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_7" name="STIC_Sec13_7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_8"  value={FormData['STIC_Sec13_8']}  name="STIC_Sec13_8" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_9"  value={FormData['STIC_Sec13_9']}  name="STIC_Sec13_9" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_10"  value={FormData['STIC_Sec13_10']}  name="STIC_Sec13_10" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">. Premium</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_11"  value={FormData['STIC_Sec13_11']}  name="STIC_Sec13_11" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_12"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_12" name="STIC_Sec13_12" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_12"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_12" name="STIC_Sec13_12" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">. Limit</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_13"  value={FormData['STIC_Sec13_13']}  name="STIC_Sec13_13" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">. Turnover</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_14"  value={FormData['STIC_Sec13_14']}  name="STIC_Sec13_14" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">. Premium</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_15"  value={FormData['STIC_Sec13_15']}  name="STIC_Sec13_15" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_16"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_16" name="STIC_Sec13_16" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_16"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_16" name="STIC_Sec13_16" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">. Limit</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_17"  value={FormData['STIC_Sec13_17']}  name="STIC_Sec13_17" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">. Turnover</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_18"  value={FormData['STIC_Sec13_18']}  name="STIC_Sec13_18" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">. Premium</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_19"  value={FormData['STIC_Sec13_19']}  name="STIC_Sec13_19" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_20"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_20" name="STIC_Sec13_20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_20"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_20" name="STIC_Sec13_20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_21"  value={FormData['STIC_Sec13_21']}  name="STIC_Sec13_21" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_22"  value={FormData['STIC_Sec13_22']}  name="STIC_Sec13_22" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_23"  value={FormData['STIC_Sec13_23']}  name="STIC_Sec13_23" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_24"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_24" name="STIC_Sec13_24" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_24"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_24" name="STIC_Sec13_24" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_25"  value={FormData['STIC_Sec13_25']}  name="STIC_Sec13_25" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_26"  value={FormData['STIC_Sec13_26']}  name="STIC_Sec13_26" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_27"  value={FormData['STIC_Sec13_27']}  name="STIC_Sec13_27" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_28"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_28" name="STIC_Sec13_28" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_28"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_28" name="STIC_Sec13_28" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec13_29"  value={FormData['STIC_Sec13_29']}  name="STIC_Sec13_29" className="form-control" placeholder="Click to enter text"  aria-describedby="" /> 
      </td>
      <td></td>
      <td></td>
      <td></td>   
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_30"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_30" name="STIC_Sec13_30" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_30"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_30" name="STIC_Sec13_30" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_31"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_31" name="STIC_Sec13_31" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_31"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_31" name="STIC_Sec13_31" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_32"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec13_32" name="STIC_Sec13_32" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec13_32"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec13_32" name="STIC_Sec13_32" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left"><b>Total annual premium for item</b>:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec13_AnnualPremium"  value={FormData['STIC_Sec13_AnnualPremium']}  name="STIC_Sec13_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec13_Comments"  value={FormData['STIC_Sec13_Comments']}  name="STIC_Sec13_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec14_Limit"  value={FormData['STIC_Sec14_Limit']}  name="STIC_Sec14_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec14_Premium"  value={FormData['STIC_Sec14_Premium']}  name="STIC_Sec14_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec14_ItemNumber"  value={FormData['STIC_Sec14_ItemNumber']}  name="STIC_Sec14_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec14_PremNumber"  value={FormData['STIC_Sec14_PremNumber']}  name="STIC_Sec14_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount1"  value={FormData['STIC_Sec14_CoverAmount1']}  name="STIC_Sec14_CoverAmount1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount2"  value={FormData['STIC_Sec14_CoverAmount2']}  name="STIC_Sec14_CoverAmount2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount3"  value={FormData['STIC_Sec14_CoverAmount3']}  name="STIC_Sec14_CoverAmount3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount4"  value={FormData['STIC_Sec14_CoverAmount4']}  name="STIC_Sec14_CoverAmount4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount5"  value={FormData['STIC_Sec14_CoverAmount5']}  name="STIC_Sec14_CoverAmount5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount6"  value={FormData['STIC_Sec14_CoverAmount6']}  name="STIC_Sec14_CoverAmount6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount7"  value={FormData['STIC_Sec14_CoverAmount7']}  name="STIC_Sec14_CoverAmount7" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount8"  value={FormData['STIC_Sec14_CoverAmount8']}  name="STIC_Sec14_CoverAmount8" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount9"  value={FormData['STIC_Sec14_CoverAmount9']}  name="STIC_Sec14_CoverAmount9" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount10"  value={FormData['STIC_Sec14_CoverAmount10']}  name="STIC_Sec14_CoverAmount10" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount11"  value={FormData['STIC_Sec14_CoverAmount11']}  name="STIC_Sec14_CoverAmount11" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec14_CoverAmount12"  value={FormData['STIC_Sec14_CoverAmount12']}  name="STIC_Sec14_CoverAmount12" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
  ...
  <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec15_Limit"  value={FormData['STIC_Sec15_Limit']}  name="STIC_Sec15_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec15_Premium"  value={FormData['STIC_Sec15_Premium']}  name="STIC_Sec15_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec15_ItemNumber"  value={FormData['STIC_Sec15_ItemNumber']}  name="STIC_Sec15_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec15_PremNumber"  value={FormData['STIC_Sec15_PremNumber']}  name="STIC_Sec15_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Limit of indemnity:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec15_1"  value={FormData['STIC_Sec15_1']}  name="STIC_Sec15_1" className="form-control" placeholder="R 0.00 Annual earnings"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td> 
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec15_1_1"  value={FormData['STIC_Sec15_1_1']}  name="STIC_Sec15_1_1" className="form-control" placeholder="R 0.00 Business turnover"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td> 
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec15_2"  value={FormData['STIC_Sec15_2']}  name="STIC_Sec15_2" className="form-control" placeholder="R 0.00 Retroactive date"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td> 
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left"></td>
      <td>
        <input spellCheck="true" id="STIC_Sec15_2_1"  value={FormData['STIC_Sec15_2_1']}  name="STIC_Sec15_2_1" type="date" className="form-control" placeholder="Click to enter date"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td> 
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec15_3"  value={FormData['STIC_Sec15_3']}  name="STIC_Sec15_3" className="form-control" placeholder="0.00 %"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td> 
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec15_AnnualPremium"  value={FormData['STIC_Sec15_AnnualPremium']}  name="STIC_Sec15_AnnualPremium" className="form-control" placeholder="R 0.00 "  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec15_Comments"  value={FormData['STIC_Sec15_Comments']}  name="STIC_Sec15_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec16_Limit"  value={FormData['STIC_Sec16_Limit']}  name="STIC_Sec16_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec16_Premium"  value={FormData['STIC_Sec16_Premium']}  name="STIC_Sec16_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec16_ItemNumber"  value={FormData['STIC_Sec16_ItemNumber']}  name="STIC_Sec16_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec16_PremNumber"  value={FormData['STIC_Sec16_PremNumber']}  name="STIC_Sec16_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec16_1"  value={FormData['STIC_Sec16_1']}  name="STIC_Sec16_1" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Number of persons</td>
      <td>
        <input spellCheck="true" id="STIC_Sec16_2"  value={FormData['STIC_Sec16_2']}  name="STIC_Sec16_2" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Occupation</td>
      <td>
        <input spellCheck="true" id="STIC_Sec16_3"  value={FormData['STIC_Sec16_3']}  name="STIC_Sec16_3" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec16_4"  value={FormData['STIC_Sec16_4']}  name="STIC_Sec16_4" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec16_5"  value={FormData['STIC_Sec16_5']}  name="STIC_Sec16_5" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec16_6"  value={FormData['STIC_Sec16_6']}  name="STIC_Sec16_6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec16_7"  value={FormData['STIC_Sec16_7']}  name="STIC_Sec16_7" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec16_8"  value={FormData['STIC_Sec16_8']}  name="STIC_Sec16_8" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec16_9"  value={FormData['STIC_Sec16_9']}  name="STIC_Sec16_9" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_10"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_10" name="STIC_Sec16_10" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_10"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_10" name="STIC_Sec16_10" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension1" name="STIC_Sec16_Extension1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension1" name="STIC_Sec16_Extension1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension2" name="STIC_Sec16_Extension2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension2" name="STIC_Sec16_Extension2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension3" name="STIC_Sec16_Extension3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension3" name="STIC_Sec16_Extension3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension4"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension4" name="STIC_Sec16_Extension4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension4"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension4" name="STIC_Sec16_Extension4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension5"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension5" name="STIC_Sec16_Extension5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension5"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension5" name="STIC_Sec16_Extension5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension6"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension6" name="STIC_Sec16_Extension6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension6"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension6" name="STIC_Sec16_Extension6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension7"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension7" name="STIC_Sec16_Extension7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension7"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension7" name="STIC_Sec16_Extension7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension8"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension8" name="STIC_Sec16_Extension8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension8"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension8" name="STIC_Sec16_Extension8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension9"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec16_Extension9" name="STIC_Sec16_Extension9" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec16_Extension9"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec16_Extension9" name="STIC_Sec16_Extension9" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left"><b>Total annual premium for item</b></td>
      <td>
        <input spellCheck="true" id="STIC_Sec16_AnnualPremium"  value={FormData['STIC_Sec16_AnnualPremium']}  name="STIC_Sec16_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec16_Comments"  value={FormData['STIC_Sec16_Comments']}  name="STIC_Sec16_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec17_Limit"  value={FormData['STIC_Sec17_Limit']}  name="STIC_Sec17_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec17_Premium"  value={FormData['STIC_Sec17_Premium']}  name="STIC_Sec17_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec17_ItemNumber"  value={FormData['STIC_Sec17_ItemNumber']}  name="STIC_Sec17_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec17_PremNumber"  value={FormData['STIC_Sec17_PremNumber']}  name="STIC_Sec17_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_1"  value={FormData['STIC_Sec17_1']}  name="STIC_Sec17_1" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Basis:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_2"  value={FormData['STIC_Sec17_2']}  name="STIC_Sec17_2" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_3"  value={FormData['STIC_Sec17_3']}  name="STIC_Sec17_3" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_4"  value={FormData['STIC_Sec17_4']}  name="STIC_Sec17_4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_5"  value={FormData['STIC_Sec17_5']}  name="STIC_Sec17_5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_6"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_6" name="STIC_Sec17_6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_6"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_6" name="STIC_Sec17_6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_7"  value={FormData['STIC_Sec17_7']}  name="STIC_Sec17_7" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_8"  value={FormData['STIC_Sec17_8']}  name="STIC_Sec17_8" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_9"  value={FormData['STIC_Sec17_9']}  name="STIC_Sec17_9" className="form-control" placeholder="Click to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
          ...
          <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_10"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_10" name="STIC_Sec17_10" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_10"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_10" name="STIC_Sec17_10" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
    ...
    <tr>
      ...
      <td>
        <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension1" name="STIC_Sec17_Extension1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension1" name="STIC_Sec17_Extension1" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit1"  value={FormData['STIC_Sec17_ExtensionLimit1']}  name="STIC_Sec17_ExtensionLimit1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium1"  value={FormData['STIC_Sec17_ExtensionPremium1']}  name="STIC_Sec17_ExtensionPremium1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension2" name="STIC_Sec17_Extension2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension2" name="STIC_Sec17_Extension2" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit2"  value={FormData['STIC_Sec17_ExtensionLimit2']}  name="STIC_Sec17_ExtensionLimit2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium2"  value={FormData['STIC_Sec17_ExtensionPremium2']}  name="STIC_Sec17_ExtensionPremium2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension3"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension3" name="STIC_Sec17_Extension3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension3"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension3" name="STIC_Sec17_Extension3" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit3"  value={FormData['STIC_Sec17_ExtensionLimit3']}  name="STIC_Sec17_ExtensionLimit3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium3"  value={FormData['STIC_Sec17_ExtensionPremium3']}  name="STIC_Sec17_ExtensionPremium3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>    
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension4"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension4" name="STIC_Sec17_Extension4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension4"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension4" name="STIC_Sec17_Extension4" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit4"  value={FormData['STIC_Sec17_ExtensionLimit4']}  name="STIC_Sec17_ExtensionLimit4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium4"  value={FormData['STIC_Sec17_ExtensionPremium4']}  name="STIC_Sec17_ExtensionPremium4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>    
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension5"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension5" name="STIC_Sec17_Extension5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension5"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension5" name="STIC_Sec17_Extension5" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit5"  value={FormData['STIC_Sec17_ExtensionLimit5']}  name="STIC_Sec17_ExtensionLimit5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium5"  value={FormData['STIC_Sec17_ExtensionPremium5']}  name="STIC_Sec17_ExtensionPremium5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>    
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension6"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension6" name="STIC_Sec17_Extension6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension6"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension6" name="STIC_Sec17_Extension6" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit6"  value={FormData['STIC_Sec17_ExtensionLimit6']}  name="STIC_Sec17_ExtensionLimit6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium6"  value={FormData['STIC_Sec17_ExtensionPremium6']}  name="STIC_Sec17_ExtensionPremium6" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>    
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension7"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension7" name="STIC_Sec17_Extension7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension7"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension7" name="STIC_Sec17_Extension7" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit7"  value={FormData['STIC_Sec17_ExtensionLimit7']}  name="STIC_Sec17_ExtensionLimit7" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium7"  value={FormData['STIC_Sec17_ExtensionPremium7']}  name="STIC_Sec17_ExtensionPremium7" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>    
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension8"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension8" name="STIC_Sec17_Extension8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension8"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension8" name="STIC_Sec17_Extension8" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit8"  value={FormData['STIC_Sec17_ExtensionLimit8']}  name="STIC_Sec17_ExtensionLimit8" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium8"  value={FormData['STIC_Sec17_ExtensionPremium8']}  name="STIC_Sec17_ExtensionPremium8" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>    
    </tr>
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension9"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec17_Extension9" name="STIC_Sec17_Extension9" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec17_Extension9"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec17_Extension9" name="STIC_Sec17_Extension9" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionLimit9"  value={FormData['STIC_Sec17_ExtensionLimit9']}  name="STIC_Sec17_ExtensionLimit9" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_ExtensionPremium9"  value={FormData['STIC_Sec17_ExtensionPremium9']}  name="STIC_Sec17_ExtensionPremium9" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>    
    </tr>
    ...
    <tr>
      ...
      <td></td>
      <td>
        <input spellCheck="true" id="STIC_Sec17_AnnualPremium"  value={FormData['STIC_Sec17_AnnualPremium']}  name="STIC_Sec17_AnnualPremium" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec17_Comments"  value={FormData['STIC_Sec17_Comments']}  name="STIC_Sec17_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec18_Limit"  value={FormData['STIC_Sec18_Limit']}  name="STIC_Sec18_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec18_Premium"  value={FormData['STIC_Sec18_Premium']}  name="STIC_Sec18_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec18_ItemNumber"  value={FormData['STIC_Sec18_ItemNumber']}  name="STIC_Sec18_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec18_PremNumber"  value={FormData['STIC_Sec18_PremNumber']}  name="STIC_Sec18_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Limit:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_1"  value={FormData['STIC_Sec18_1']}  name="STIC_Sec18_1" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_2"  value={FormData['STIC_Sec18_2']}  name="STIC_Sec18_2" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Limit:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_3"  value={FormData['STIC_Sec18_3']}  name="STIC_Sec18_3" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_4"  value={FormData['STIC_Sec18_4']}  name="STIC_Sec18_4" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_5"  value={FormData['STIC_Sec18_5']}  name="STIC_Sec18_5" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
  ...
  <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_6"  value={FormData['STIC_Sec18_6']}  name="STIC_Sec18_6" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_7"  value={FormData['STIC_Sec18_7']}  name="STIC_Sec18_7" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_8"  value={FormData['STIC_Sec18_8']}  name="STIC_Sec18_8" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_9"  value={FormData['STIC_Sec18_9']}  name="STIC_Sec18_9" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Year manufactured:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_10"  value={FormData['STIC_Sec18_10']}  name="STIC_Sec18_10" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_11"  value={FormData['STIC_Sec18_11']}  name="STIC_Sec18_11" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_12"  value={FormData['STIC_Sec18_12']}  name="STIC_Sec18_12" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Model:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_13"  value={FormData['STIC_Sec18_13']}  name="STIC_Sec18_13" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_14"  value={FormData['STIC_Sec18_14']}  name="STIC_Sec18_14" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Sum insured:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_15"  value={FormData['STIC_Sec18_15']}  name="STIC_Sec18_15" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_16"  value={FormData['STIC_Sec18_16']}  name="STIC_Sec18_16" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">GVM/CC:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_17"  value={FormData['STIC_Sec18_17']}  name="STIC_Sec18_17" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_18"  value={FormData['STIC_Sec18_18']}  name="STIC_Sec18_18" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_19"  value={FormData['STIC_Sec18_19']}  name="STIC_Sec18_19" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>
      <td></td>
      <td></td>  
    ...
    <tr>
      ...
      <div className="row col-6 align-items-center">
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec18_20"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec18_20" name="STIC_Sec18_20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    Yes
            ...
            <div className="col-3">
                <input className="form-check-input" checked={FormData["STIC_Sec18_20"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec18_20" name="STIC_Sec18_20" />
            </div>
            <div className="col-3">
                <label className="form-check-label"  >
                    No
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_21"  value={FormData['STIC_Sec18_21']}  name="STIC_Sec18_21" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_22"  value={FormData['STIC_Sec18_22']}  name="STIC_Sec18_22" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_23"  value={FormData['STIC_Sec18_23']}  name="STIC_Sec18_23" className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Limit:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_24"  value={FormData['STIC_Sec18_24']}  name="STIC_Sec18_24" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_25"  value={FormData['STIC_Sec18_25']}  name="STIC_Sec18_25" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Limit:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_26"  value={FormData['STIC_Sec18_26']}  name="STIC_Sec18_26" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}} align="left">Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_27"  value={FormData['STIC_Sec18_27']}  name="STIC_Sec18_27" className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} /> 
      </td>
      <td></td>  
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP1_1"  value={FormData['STIC_Sec18_FaP1_1']}  name="STIC_Sec18_FaP1_1" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>% of claim/sum insured with minimum amount of R</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP1_2"  value={FormData['STIC_Sec18_FaP1_2']}  name="STIC_Sec18_FaP1_2" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
    </tr>
  ...
  <br/>
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP2_1"  value={FormData['STIC_Sec18_FaP2_1']}  name="STIC_Sec18_FaP2_1" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>% of claims amount/sum insured with minimum amount of R</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP2_2"  value={FormData['STIC_Sec18_FaP2_2']}  name="STIC_Sec18_FaP2_2" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP3_1"  value={FormData['STIC_Sec18_FaP3_1']}  name="STIC_Sec18_FaP3_1" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>% of claims amount/sum insured with minimum amount of R</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP3_2"  value={FormData['STIC_Sec18_FaP3_2']}  name="STIC_Sec18_FaP3_2" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
    </tr>
    ...
    <tr>
      ...
      <td></td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP4_1"  value={FormData['STIC_Sec18_FaP4_1']}  name="STIC_Sec18_FaP4_1" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP5_1"  value={FormData['STIC_Sec18_FaP5_1']}  name="STIC_Sec18_FaP5_1" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>% of claims amount/sum insured with minimum amount of R</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP5_2"  value={FormData['STIC_Sec18_FaP5_2']}  name="STIC_Sec18_FaP5_2" className="form-control" placeholder="0.00"  aria-describedby="" /> 
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP6_1"  value={FormData['STIC_Sec18_FaP6_1']}  name="STIC_Sec18_FaP6_1" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_FaP6_2"  value={FormData['STIC_Sec18_FaP6_2']}  name="STIC_Sec18_FaP6_2" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Limit:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_Extension1_1"  value={FormData['STIC_Sec18_Extension1_1']}  name="STIC_Sec18_Extension1_1" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_Extension1_2"  value={FormData['STIC_Sec18_Extension1_2']}  name="STIC_Sec18_Extension1_2" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_Extension2_1"  value={FormData['STIC_Sec18_Extension2_1']}  name="STIC_Sec18_Extension2_1" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_Extension3_1"  value={FormData['STIC_Sec18_Extension3_1']}  name="STIC_Sec18_Extension3_1" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_Extension4_1"  value={FormData['STIC_Sec18_Extension4_1']}  name="STIC_Sec18_Extension4_1" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_Extension5_1"  value={FormData['STIC_Sec18_Extension5_1']}  name="STIC_Sec18_Extension5_1" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>Premium:</td>
      <td>
        <input spellCheck="true" id="STIC_Sec18_Extension6_1"  value={FormData['STIC_Sec18_Extension6_1']}  name="STIC_Sec18_Extension6_1" className="form-control" placeholder="0.00"  aria-describedby=""  /> 
      </td>
      <td></td>
      <td></td>
    </tr>
    ...
    <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec18_Comments"  value={FormData['STIC_Sec18_Comments']}  name="STIC_Sec18_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec19_Limit"  value={FormData['STIC_Sec19_Limit']}  name="STIC_Sec19_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec19_Premium"  value={FormData['STIC_Sec19_Premium']}  name="STIC_Sec19_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec19_ItemNumber"  value={FormData['STIC_Sec19_ItemNumber']}  name="STIC_Sec19_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec19_PremNumber"  value={FormData['STIC_Sec19_PremNumber']}  name="STIC_Sec19_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
      ...
      <div className="row">
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part1_1"  value={FormData['STIC_Sec19_Part1_1']}  name="STIC_Sec19_Part1_1"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part1_2"  value={FormData['STIC_Sec19_Part1_2']}  name="STIC_Sec19_Part1_2"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part1_3"  value={FormData['STIC_Sec19_Part1_3']}  name="STIC_Sec19_Part1_3"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part1_4"  value={FormData['STIC_Sec19_Part1_4']}  name="STIC_Sec19_Part1_4"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part1_5"  value={FormData['STIC_Sec19_Part1_5']}  name="STIC_Sec19_Part1_5"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec19_Part1_6"  value={FormData['STIC_Sec19_Part1_6']}  name="STIC_Sec19_Part1_6"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part1_7"  value={FormData['STIC_Sec19_Part1_7']}  name="STIC_Sec19_Part1_7"  className="form-control" placeholder="0.00 %"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part1_8"  value={FormData['STIC_Sec19_Part1_8']}  name="STIC_Sec19_Part1_8"  className="form-control" placeholder="0.00 %"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec19_Part1_9"  value={FormData['STIC_Sec19_Part1_9']}  name="STIC_Sec19_Part1_9"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part2_1"  value={FormData['STIC_Sec19_Part2_1']}  name="STIC_Sec19_Part2_1"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part2_3"  value={FormData['STIC_Sec19_Part2_3']}  name="STIC_Sec19_Part2_3"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec19_Part2_4"  value={FormData['STIC_Sec19_Part2_4']}  name="STIC_Sec19_Part2_4"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_Part2_5"  value={FormData['STIC_Sec19_Part2_5']}  name="STIC_Sec19_Part2_5"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec19_Part2_6"  value={FormData['STIC_Sec19_Part2_6']}  name="STIC_Sec19_Part2_6"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="row col-4 align-items-center">
                      <div className="col-3">
                          <input className="form-check-input" checked={FormData["STIC_Sec19_Extension1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec19_Extension1" name="STIC_Sec19_Extension1" />
                      </div>
                      <div className="col-3">
                          <label className="form-check-label"  >
                              Yes
                      ...
                      <div className="col-3">
                          <input className="form-check-input" checked={FormData["STIC_Sec19_Extension1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec19_Extension1" name="STIC_Sec19_Extension1" />
                      </div>
                      <div className="col-3">
                          <label className="form-check-label"  >
                              No
                  ...
                  <div className="col-2">
                    <input spellCheck="true" id="STIC_Sec19_Extension_Premium1"  value={FormData['STIC_Sec19_Extension_Premium1']}  name="STIC_Sec19_Extension_Premium1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="row col-4 align-items-center">
                      <div className="col-3">
                          <input className="form-check-input" checked={FormData["STIC_Sec19_Extension2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec19_Extension2" name="STIC_Sec19_Extension2" />
                      </div>
                      <div className="col-3">
                          <label className="form-check-label"  >
                              Yes
                      ...
                      <div className="col-3">
                          <input className="form-check-input" checked={FormData["STIC_Sec19_Extension2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec19_Extension2" name="STIC_Sec19_Extension2" />
                      </div>
                      <div className="col-3">
                          <label className="form-check-label"  >
                              No
                  ...
                  <div className="col-2">
                    <input spellCheck="true" id="STIC_Sec19_Extension_Premium2"  value={FormData['STIC_Sec19_Extension_Premium2']}  name="STIC_Sec19_Extension_Premium2"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_RoD_1"  value={FormData['STIC_Sec19_RoD_1']}  name="STIC_Sec19_RoD_1"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_RoD_2"  value={FormData['STIC_Sec19_RoD_2']}  name="STIC_Sec19_RoD_2"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec19_RoD_3"  value={FormData['STIC_Sec19_RoD_3']}  name="STIC_Sec19_RoD_3"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_RoD_4"  value={FormData['STIC_Sec19_RoD_4']}  name="STIC_Sec19_RoD_4"  className="form-control" placeholder="0.00 %"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec19_RoD_5"  value={FormData['STIC_Sec19_RoD_5']}  name="STIC_Sec19_RoD_5"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec19_AnnualPremium"  value={FormData['STIC_Sec19_AnnualPremium']}  name="STIC_Sec19_AnnualPremium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
  ...
  <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec19_Comments"  value={FormData['STIC_Sec19_Comments']}  name="STIC_Sec19_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec20_Limit"  value={FormData['STIC_Sec20_Limit']}  name="STIC_Sec20_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec20_Premium"  value={FormData['STIC_Sec20_Premium']}  name="STIC_Sec20_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
              </div>
          </div>
      </div>
      ...
      <div className="col-12" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec20_ItemNumber"  value={FormData['STIC_Sec20_ItemNumber']}  name="STIC_Sec20_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
              ...
              <div className="col-4">
                <input spellCheck="true" id="STIC_Sec20_PremNumber"  value={FormData['STIC_Sec20_PremNumber']}  name="STIC_Sec20_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
              </div>
          </div>
      </div>
    </div>
    <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
      <div className="row">
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec20_1"  value={FormData['STIC_Sec20_1']}  name="STIC_Sec20_1"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec20_2"  value={FormData['STIC_Sec20_2']}  name="STIC_Sec20_2"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec20_3"  value={FormData['STIC_Sec20_3']}  name="STIC_Sec20_3"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec20_4"  value={FormData['STIC_Sec20_4']}  name="STIC_Sec20_4"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec20_5"  value={FormData['STIC_Sec20_5']}  name="STIC_Sec20_5"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec20_6"  value={FormData['STIC_Sec20_6']}  name="STIC_Sec20_6"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="row col-4 align-items-center">
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec20_Extension1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec20_Extension1" name="STIC_Sec20_Extension1" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            Yes
                    ...
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec20_Extension1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec20_Extension1" name="STIC_Sec20_Extension1" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            No
                  ...
                  <div className="col-2">
                    <input spellCheck="true" id="STIC_Sec20_Extension_Premium1"  value={FormData['STIC_Sec20_Extension_Premium1']}  name="STIC_Sec20_Extension_Premium1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="row col-4 align-items-center">
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec20_Extension2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec20_Extension2" name="STIC_Sec20_Extension2" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            Yes
                    ...
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec20_Extension2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec20_Extension2" name="STIC_Sec20_Extension2" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            No
                  ...
                  <div className="col-2">
                    <input spellCheck="true" id="STIC_Sec20_Extension_Premium2"  value={FormData['STIC_Sec20_Extension_Premium2']}  name="STIC_Sec20_Extension_Premium2"  className="form-control" placeholder="0.00 %"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec20_AnnualPremium"  value={FormData['STIC_Sec20_AnnualPremium']}  name="STIC_Sec20_AnnualPremium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
      ...
      <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec20_Comments"  value={FormData['STIC_Sec20_Comments']}  name="STIC_Sec20_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
    ...
    <div style={{fontFamily: 'Arial Narrow',fontSize: '9'}}>
      <div className="row">
        <div className="row" style={{fontSize:'14px',fontFamily:'Arial Narrow Bold'}}>
          ...
          <div className="col-12" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
                ...
                <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec21_Limit"  value={FormData['STIC_Sec21_Limit']}  name="STIC_Sec21_Limit"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                </div>
                ...
                <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec21_Premium"  value={FormData['STIC_Sec21_Premium']}  name="STIC_Sec21_Premium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                </div>
            </div>
        </div>
        ...
        <div className="col-12" style={{paddingBottom: "0.5%"}}>
            <div className="row g-3 align-items-center">
                ...
                <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec21_ItemNumber"  value={FormData['STIC_Sec21_ItemNumber']}  name="STIC_Sec21_ItemNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
                ...
                <div className="col-4">
                  <input spellCheck="true" id="STIC_Sec21_PremNumber"  value={FormData['STIC_Sec21_PremNumber']}  name="STIC_Sec21_PremNumber"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                </div>
            </div>
        </div>
        </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec21_1"  value={FormData['STIC_Sec21_1']}  name="STIC_Sec21_1"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec21_2"  value={FormData['STIC_Sec21_2']}  name="STIC_Sec21_2"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec21_3"  value={FormData['STIC_Sec21_3']}  name="STIC_Sec21_3"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec21_4"  value={FormData['STIC_Sec21_4']}  name="STIC_Sec21_4"  className="form-control" placeholder="0.00"  aria-describedby=""/>
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec21_5"  value={FormData['STIC_Sec21_5']}  name="STIC_Sec21_5"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_Sec21_6"  value={FormData['STIC_Sec21_6']}  name="STIC_Sec21_6"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="row col-4 align-items-center">
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec21_Extension1"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec21_Extension1" name="STIC_Sec21_Extension1" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            Yes
                    ...
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec21_Extension1"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec21_Extension1" name="STIC_Sec21_Extension1" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            No
                  ...
                  <div className="col-2">
                    <input spellCheck="true" id="STIC_Sec21_Extension_Premium1"  value={FormData['STIC_Sec21_Extension_Premium1']}  name="STIC_Sec21_Extension_Premium1"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="row col-4 align-items-center">
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec21_Extension2"] == 1 ? true : false}  type="radio" value="1" id="STIC_Sec21_Extension2" name="STIC_Sec21_Extension2" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            Yes
                    ...
                    <div className="col-3">
                        <input className="form-check-input" checked={FormData["STIC_Sec21_Extension2"] == 0 ? true : false}  type="radio" value="0" id="STIC_Sec21_Extension2" name="STIC_Sec21_Extension2" />
                    </div>
                    <div className="col-3">
                        <label className="form-check-label"  >
                            No
                  ...
                  <div className="col-2">
                    <input spellCheck="true" id="STIC_Sec21_Extension_Premium2"  value={FormData['STIC_Sec21_Extension_Premium2']}  name="STIC_Sec21_Extension_Premium2"  className="form-control" placeholder="0.00 %"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_Sec21_AnnualPremium"  value={FormData['STIC_Sec21_AnnualPremium']}  name="STIC_Sec21_AnnualPremium"  className="form-control" placeholder="R 0.00"  aria-describedby="" style={{width:"200px"}} />
                  </div>
      ...
      <br/>
    <div><b>Comments</b></div>
      <input spellCheck="true" id="STIC_Sec21_Comments"  value={FormData['STIC_Sec21_Comments']}  name="STIC_Sec21_Comments"  className="form-control" placeholder="Click or tap here to enter text"  aria-describedby="" style={{width:"1000px"}} />
    <br/>
      ...
      <div className="row">
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecD_1"  value={FormData['STIC_SecD_1']}  name="STIC_SecD_1"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecD_2"  value={FormData['STIC_SecD_2']}  name="STIC_SecD_2"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_SecD_3"  value={FormData['STIC_SecD_3']}  name="STIC_SecD_3"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                    <div className="row col-6 align-items-center">
                      <div className="col-3">
                          <input className="form-check-input" checked={FormData["STIC_SecD_4"] == 1 ? true : false}  type="radio" value="1" id="STIC_SecD_4" name="STIC_SecD_4" />
                      </div>
                      <div className="col-3">
                          <label className="form-check-label"  >
                              Yes
                      ...
                      <div className="col-3">
                          <input className="form-check-input" checked={FormData["STIC_SecD_4"] == 0 ? true : false}  type="radio" value="0" id="STIC_SecD_4" name="STIC_SecD_4" />
                      </div>
                      <div className="col-3">
                          <label className="form-check-label"  >
                              No
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecD_5"  value={FormData['STIC_SecD_5']}  name="STIC_SecD_5"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
{/* 
                  <div className="col-2">
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_SecD_6"  value={FormData['STIC_SecD_6']}  name="STIC_SecD_6"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div> */}
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecD_7"  value={FormData['STIC_SecD_7']}  name="STIC_SecD_7"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecD_8"  value={FormData['STIC_SecD_8']}  name="STIC_SecD_8"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecD_9"  value={FormData['STIC_SecD_9']}  name="STIC_SecD_9"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecD_10"  value={FormData['STIC_SecD_10']}  name="STIC_SecD_10"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input type="date" spellCheck="true" id="STIC_SecD_11"  value={FormData['STIC_SecD_11']}  name="STIC_SecD_11"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                    ...
                    {/* <input spellCheck="true" id="STIC_SecD_12"  value={FormData['STIC_SecD_12']}  name="STIC_SecD_12"  className="form-control" placeholder="Sign here"  aria-describedby="" style={{width:"200px"}} /> */}
                  </div>
                  ...
                  <div className="col-4">
                    <input spellCheck="true" id="STIC_SecD_13"  value={FormData['STIC_SecD_13']}  name="STIC_SecD_13"  type="date" className="form-control" placeholder="Sign here"  aria-describedby="" style={{width:"200px"}} />
                  </div>
    ...
    {/* <textarea maxLength={500} spellCheck="true" id="STIC_SecE_1"  value={FormData['STIC_SecE_1']}  name="STIC_SecE_1"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"1000px",height:"100px"}} /> */}
    <Editor
    ...
    {/* <textarea maxLength={500} spellCheck="true" id="STIC_SecE_2"  value={FormData['STIC_SecE_2']}  name="STIC_SecE_2"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"1000px",height:"100px"}} /> */}
    <Editor
    ...
    {/* <textarea maxLength={500} spellCheck="true" id="STIC_SecE_3"  value={FormData['STIC_SecE_3']}  name="STIC_SecE_3"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"1000px",height:"100px"}} /> */}
    <Editor
      ...
      <div className="row">
          ...
          <div className="col-16" style={{paddingBottom: "0.5%"}}>
              <div className="row g-3 align-items-center">
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecG_1"  value={FormData['STIC_SecG_1']}  name="STIC_SecG_1"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
                  ...
                  <div className="col-4">
                      <input spellCheck="true" id="STIC_SecG_2"  value={FormData['STIC_SecG_2']}  name="STIC_SecG_2"  className="form-control" placeholder="Click here to enter text"  aria-describedby="" style={{width:"200px"}} />
                  </div>
              </div>
          </div>
        ...
        <div className="col-16" style={{paddingBottom: "0.5%"}}>
          <div className="row g-3 align-items-center">
              ...
              <div className="col-4">
                ...
                {/* <input spellCheck="true" id="STIC_Branch_Number"  value={FormData['STIC_Branch_Number']}  name="STIC_Branch_Number"  className="form-control" placeholder="Sign here"  aria-describedby="" style={{width:"200px"}} /> */}
              </div>
              <div className="col-2">
                  <label className="col-form-label">Date(dd/mm/yyyy):</label>
              </div>
              <div className="col-4">
                <input spellCheck="true" id="STIC_SecG_3"  value={FormData['STIC_SecG_3']}  name="STIC_SecG_3"  type="date" className="form-control" placeholder="Sign here"  aria-describedby="" style={{width:"200px"}} />
              </div>
            </div>
        </div>
