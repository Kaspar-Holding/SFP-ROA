        ...
        const LoadRFForm = async(advisorId, formId) => {
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    let results = response?.data?.formData
                            ...
                            <div className='col-4'>
                                {
                                    FormData.status == 4 ?
                                    <button  className= { 
                                        user['email'].includes('sfp') || user['email'].includes('succession')? "btn btn-danger sfp col-11" 
                                        : user['email'].includes('fs4p') ? "btn btn-danger fs4p col-11" 
                                        : user['email'].includes('sanlam') ? "btn btn-danger sanlam col-11" 
                                        : "btn btn-danger sfp col-8"
                                    }>
                                        Blocked
                                    </button>
                                    : FormData.status == 3 ?
                                    ...
                                    : FormData.status == 2 ?
                                    <button  className= { 
                                        user['email'].includes('sfp') || user['email'].includes('succession')? "btn btn-warning sfp col-11" 
                                        : user['email'].includes('fs4p') ? "btn btn-warning fs4p col-11" 
                                        : user['email'].includes('sanlam') ? "btn btn-warning sanlam col-11" 
                                        : "btn btn-warning sfp col-8"
                                    }>
                                        Awaiting Approval
                                    </button>
                                    : 
