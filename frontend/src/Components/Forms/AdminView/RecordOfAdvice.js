                        ...
                        <div className="row">
                            <div className="col-6" style={{paddingBottom: "0.5%"}}>
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-6">
                                        <input required minlength="3" and maxlength="45" id="clientName" value={FormData['clientName']}  name="clientName" className="form-control" placeholder="Client Name"  aria-describedby="" type="text" />
                                    </div>
                                </div>
                            </div>
                            <div className="col-6" style={{paddingBottom: "0.5%"}}>
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-6">
                                        <input required type="number" id="clientIdNumber" value={FormData['clientIdNumber']}   name="clientIdNumber" className="form-control" placeholder="ID number"  aria-describedby="" />
                                    </div>
                                </div>
                            </div>
                            <hr className="col-11" />
                            <div className="col-12" style={{paddingBottom: "0.5%"}}>
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-9">
                                        <input required spellCheck="true"  id="clientAddress" value={FormData['clientAddress']}  name="clientAddress" className="form-control" placeholder="Address"  aria-describedby="" />
                                    </div>
                                </div>
                            </div>
                            <hr className="col-11" />
                            <div className="col-6" style={{paddingBottom: "0.5%"}}>
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-6">
                                        <input type="email" required spellCheck="true" size="30"  id="email" value={FormData['clientEmail']} name="clientEmail" className="form-control" placeholder="user@succession.co.za"  aria-describedby="" />
                                    </div>
                                </div>
                            </div>
                            <div className="col-6" style={{paddingBottom: "0.5%"}}>
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-6">
                                        <input required spellCheck="true" minLength="10" type="number" id="clientPhoneNumber" value={FormData['clientPhoneNumber']} name="clientPhoneNumber" className="form-control" placeholder="Phone"  aria-describedby="" />
                                    </div>
                                </div>
                            </div>
                            <hr className="col-11" />
                            ...
                            <div className="col-6" style={{paddingBottom: "0.5%"}}>
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-6">
                                        <input required spellCheck="true"  type="date"  id="clientDateOfBirth" value={FormData['clientDateOfBirth']}  name="clientDateOfBirth" className="form-control" placeholder="date_of_birth"  aria-describedby="" />
                                    </div>
                                </div>
                            </div>
                            <hr className="col-11" />
                                    ...
                                    <div className="col-6">
                                        <div className="row">
                                            <div className="row col-2 align-items-center">
                                                <div className="col-2">
                                                    <input className="form-check-input" checked={FormData['clientLetterOfIntroduction'] == 1 ? true : false}   type="radio" value="1" id="provided_identity_radio_btn" name="clientLetterOfIntroduction"/>
                                                </div>
                                                <div className="col-2">
                                            ...
                                            <div className="row col-2 align-items-center">
                                                <div className="col-2">
                                                    <input className="form-check-input" checked={FormData['clientLetterOfIntroduction'] == 0 ? true : false}   type="radio" value="0" id="provided_identity_radio_btn" name="clientLetterOfIntroduction"/>
                                                </div>
                                                <div className="col-2">
                                                    <label className="form-check-label" htmlFor="provided_identity_radio_btn" >
                                                        No
                                    ...
                                    {/* {
                                        ...
                                        <>
                                            <div className="col-11" id="letter_of_introduction_2">
                                                ...
                                                <textarea  id="letter_of_introduction" name="letterOfIntroductionReason"   onFocus={letter_of_introduction_onFocus} onBlur={letter_of_introduction_onBlur} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea>
                                            </div>
                                        </>
                                    } */}
                                </div>
                                ...
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-6">
                                        <div className="row">
                                            <div className="row col-2 align-items-center">
                                                <div className="col-2">
                                                    <input required className="form-check-input" checked={FormData['clientLetterOfIntroductionAccess'] == 1 ? true : false}   type="radio" value="1" id="provided_identity_radio_btn" name="clientLetterOfIntroductionAccess"/>
                                                </div>
                                                <div className="col-2">
                                                    <label className="form-check-label" htmlFor="provided_identity_radio_btn" >
                                                        Yes
                                            ...
                                            <div className="row col-2 align-items-center">
                                                <div className="col-2">
                                                    <input required className="form-check-input" checked={FormData['clientLetterOfIntroductionAccess'] == 0 ? true : false}   type="radio" value="0" id="provided_identity_radio_btn" name="clientLetterOfIntroductionAccess"/>
                                                </div>
                                                <div className="col-2">
                                                    <label className="form-check-label" htmlFor="provided_identity_radio_btn" >
                                                        No
                                    ...
                                    <div className="col-11" id="authority_access_2" >
                                        ...
                                        {/* <textarea id="authority_access" required={FormData['clientLetterOfIntroductionAccess'] === 0 ? true : false}  maxLength={256} name="clientLetterOfIntroductionAccessReasonReason" value={FormData['clientLetterOfIntroductionAccessReason']}   onFocus={letter_of_introduction_access_onFocusReason} onBlur={letter_of_introduction_access_onBlurReason} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea> */}
                                        <Editor
                                    ...
                                    {/* {
                                        ...
                                        <>
                                            <div className="col-11" id="authority_access_2" >
                                                ...
                                                <textarea  id="authority_access" name="letterOfIntroductionAccessReason"   onFocus={letter_of_introduction_access_onFocus} onBlur={letter_of_introduction_access_onBlur} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea>
                                            </div>
                                        </>
                                    } */}
                                </div>
                                ...
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-6">
                                        <div className="row">
                                            <div className="row col-2 align-items-center">
                                                <div className="col-2">
                                                    <input required className="form-check-input" checked={FormData['clientFica'] == 1 ? true : false}   type="radio" value="1" id="provided_identity_radio_btn" name="clientFica"/>
                                                </div>
                                                <div className="col-2">
                                                    <label className="form-check-label" htmlFor="provided_identity_radio_btn" >
                                                        Yes
                                            ...
                                            <div className="row col-2 align-items-center">
                                                <div className="col-2">
                                                    <input required className="form-check-input" checked={FormData['clientFica'] == 0 ? true : false}   type="radio" value="0" id="provided_identity_radio_btn" name="clientFica"/>
                                                </div>
                                                <div className="col-2">
                                                    <label className="form-check-label" htmlFor="provided_identity_radio_btn" >
                                                        No
                                    ...
                                    <div className="col-11" id="provided_identity_2" >
                                        ...
                                        {/* <textarea  id="provided_identity" required={FormData['clientFica'] === 0 ? true : false} value={FormData['clientFicaReason']}  maxLength={256} name="clientFicaReason" onFocus={fica_onFocus} onBlur={fica_onBlur} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea> */}
                                        <Editor
                                    ...
                                    {/* {
                                        ...
                                        <>
                                            <div className="col-11" id="provided_identity_2" >
                                                ...
                                                <textarea  id="provided_identity" name="ficaReason" onFocus={fica_onFocus} onBlur={fica_onBlur} className="form-control" placeholder="If no, motivate" aria-describedby="" ></textarea>
                                            </div>
                                        </>
                                    } */}
                                </div>
