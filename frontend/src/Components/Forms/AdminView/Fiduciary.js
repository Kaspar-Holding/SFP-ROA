                      ...
                      <div className="col-12" style={{paddingBottom: "0.5%"}}>
                            <div className="row g-3 align-items-center">
                                ...
                                <div className="col-1">
                                  <label className="radio-inline">
                                      <input onMouseLeave={(e)=>{onFieldBlur(e)}} type="radio" className="form-check-input"  name="fiduciaryWillInPlace" checked={FormData['fiduciaryWillInPlace'] == 1 ? true : false}  value="1"/>Yes
                                  </label>
                                </div>
                                <div className="col-1">
                                  <label className="radio-inline">
                                      <input onMouseLeave={(e)=>{onFieldBlur(e)}} type="radio" className="form-check-input"  name="fiduciaryWillInPlace" checked={FormData['fiduciaryWillInPlace'] == 0 ? true : false}  value="0"/>No
                                  </label>
                                </div>
                            </div>
                          ...
                          <hr/>
                            <div className="row g-3 align-items-center">
                                ...
                                <div className="col-6">
                                  <input onBlur={(e)=>{onFieldBlur(e)}} spellCheck="true"  type="date" id="fiduciaryWillUpdationDate"  value={FormData['fiduciaryWillUpdationDate']}  name="fiduciaryWillUpdationDate" className="form-control" placeholder="Click to enter text"  aria-describedby="" />
                                </div>
                            </div>
                            ...
                            <div className="row g-3 align-items-center">
                                ...
                                <div className="col-6">
                                  <input onBlur={(e)=>{onFieldBlur(e)}} spellCheck="true" id="fiduciaryWillKeepingPlace"  value={FormData['fiduciaryWillKeepingPlace']} name="fiduciaryWillKeepingPlace" className="form-control" placeholder="Click to enter text"  aria-describedby="" />
                                </div>
                            </div>
                            ...
                            <div className="row g-3 align-items-center">
                                ...
                                <div className="col-6">
                                  <input onBlur={(e)=>{onFieldBlur(e)}} spellCheck="true" id="fiduciaryExecutorDetails"  value={FormData['fiduciaryExecutorDetails']} name="fiduciaryExecutorDetails" className="form-control" placeholder="Click to enter text"  aria-describedby="" />
                                </div>
                            </div>
                            ...
                            <div className="row g-3 align-items-center">
                                ...
                                <div className="col-6">
                                  <input onBlur={(e)=>{onFieldBlur(e)}} spellCheck="true"  id="fiduciaryClientInstructions"  value={FormData['fiduciaryClientInstructions']} name="fiduciaryClientInstructions" className="form-control" placeholder="Click to enter text"  aria-describedby="" />
                                </div>
                            </div>
                            ...
                            <div className="row g-3 align-items-center">
                                ...
                                <div className="col-6">
                                  <input onBlur={(e)=>{onFieldBlur(e)}} spellCheck="true" id="fiduciaryConsequencesExplained"  value={FormData['fiduciaryConsequencesExplained']}  name="fiduciaryConsequencesExplained" className="form-control" placeholder="Click to enter text"  aria-describedby="" />
                                </div>
                            </div>
