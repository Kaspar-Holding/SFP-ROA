...
const ComplianceFormLayout = (props) => {
                        ...
                        <div className="d-flex flex-column flex-shrink-0 bg-white rounded-5 rounded-start-0 card1">
                            ...
                            <div className='d-flex justify-content-center'>
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        <li className="breadcrumb-item"><NavLink to="/compliance">Compliance</NavLink></li>
                                        <li className="breadcrumb-item active" aria-current="page">
                                            {
                                                location.pathname == "/create-compliance-document" ? "Create Document" :
                                                location.pathname == "/complete-compliance-document" ? "Complete Document" : ""
                                            }
                                        </li>
                                    </ol>
                                </nav>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-7 col-md-6 col-sm-7">
                                    <span className="form-header">Compliance</span><br/>
...
export default connect(mapStateToProps, {LogOut})(ComplianceFormLayout)