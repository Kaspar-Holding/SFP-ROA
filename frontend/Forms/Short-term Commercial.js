                            ...
                            <div class="container-fluid">
                              ...
                              <tbody>
                                      ...
                                      <tr class="d-flex">
                                          ...
                                          <td class="col-2" style={{width:"200px"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>.</b>&nbsp;Employer Liability</td>
                                          <td class="col-2" style={{width:"130px"}}>
                                              <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" align="centre"/>
                                          </td>
                                      ...
                                      <tr class="d-flex">
                                          ...
                                          <td class="col-2" style={{width:"200px"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>.</b>&nbsp;Directors and officers &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; liability</td>
                                          <td class="col-2" style={{width:"130px"}}>
                                              <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" align="centre"/>
                                          </td>
                              ...
                              <div class="text-start "style={{ color: "#14848A" ,fontSize:'18px',fontFamily:'Arial Bold',fontWeight:'bold'}} > <b>SECTION A:FIRE</b></div>
