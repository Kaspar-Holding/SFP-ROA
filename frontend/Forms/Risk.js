...
function  Risk()
{
   ...
   <br/>
   <div class="text-start "style={{ color: "#14848A" ,fontSize:'36.66px',fontFamily:'Arial Bold',fontWeight:'bold'}} > <b>RISK</b></div>
   <hr/>
        <h5 class="text-start " style={{ color: "#14848A"}} > <b>Financial Needs Analysis Summary</b></h5>  
  ...
  <h5 class="text-start " ><b>SECTION C:</b></h5> 
        ...
        <p class="text-start">Summary of recommendations to address your identified needs.</p>
        <p class="text-start"> No cash values are payable/accessible unless a specified event has occurred, i.e., the life event for which cover is taken; in which case the proceeds are payable tax-free. The premiums are not tax-deductible according to current legislation and loans against the policy are not permitted.</p>    
        <p class="text-start">Should the policy have an accelerator benefit attached, it means that upon a claim of that benefit the life cover amount will reduce by the claim amount. Standalone benefits are independent of the life cover, and you may claim without affecting the life cover amounts.</p>
        <p class="text-start"><u>Life Cover:</u></p>
        <p class="text-start">Policies payable to the estate will attract executors’ fees at a maximum of 3.99% + VAT. Where there is a beneficiary the executors fees will not be levied. Executors’ fees are applicable to all assets in the estate of a client and the exemption only applies to policies with beneficiaries. </p>
        <p class="text-start">Death benefits will not be paid where the life insured commits suicide within 2 years of commencement or reinstatement of the cover.</p>
...
<p class="text-start"><u>Disability Cover:</u></p>
{
...
<p class="text-start"><u>Dread Disease Cover:</u></p>
{
...
<h5 class="text-start " ><b>SECTION D:</b></h5> 
        ...
        <p class="text-start">The following solutions were presented to you for consideration but were not selected for the following reasons:</p>
...
<h5 class="text-start " ><b>SECTION E:</b></h5> 
        ...
        <p class="text-start ">Products accepted by you to meet your requirements. </p> 
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td>  
        <div class="form-group">
            <input type="text" value="chilli" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""/>
        </div>
       </td>  
       <td></td>
...
<p class="text-start">The following are reasons why the above-mentioned product best suits your needs and objectives</p>

{
    ...
    <textarea  id="background_info7" name="background_info7" className="form-control"  style={{height: '80px'}} 
        ...
        `}  aria-describedby=""  ></textarea>
<hr/>
<p class="text-start">The details of the material aspects of the selected product that were discussed with you are outlined below:</p>
