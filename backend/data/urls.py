...
urlpatterns = [
    ...
    path('update_stic_sec_1_Data/' , views.update_stic_sec_1_Data, name="STIP Sec 1 Fire Data"),
    path('update_stic_sec_2_Data/' , views.update_stic_sec_2_Data, name="STIP Sec 2 Fire Data"),
    path('update_stic_sec_3_Data/' , views.update_stic_sec_3_Data, name="STIP Sec 3 Fire Data"),
    path('update_stic_sec_4_Data/' , views.update_stic_sec_4_Data, name="STIP Sec 4 Fire Data"),
    path('update_stic_sec_5_Data/' , views.update_stic_sec_5_Data, name="STIP Sec 5 Fire Data"),
    path('update_stic_sec_6_Data/' , views.update_stic_sec_6_Data, name="STIP Sec 6 Fire Data"),
    path('update_stic_sec_7_Data/' , views.update_stic_sec_7_Data, name="STIP Sec 7 Fire Data"),
    path('update_stic_sec_8_Data/' , views.update_stic_sec_8_Data, name="STIP Sec 8 Fire Data"),
    path('update_stic_sec_9_Data/' , views.update_stic_sec_9_Data, name="STIP Sec 9 Fire Data"),
    path('update_stic_sec_10_Data/' , views.update_stic_sec_10_Data, name="STIP Sec 10 Fire Data"),
    path('update_stic_sec_11_Data/' , views.update_stic_sec_11_Data, name="STIP Sec 11 Fire Data"),
    path('update_stic_sec_12_Data/' , views.update_stic_sec_12_Data, name="STIP Sec 12 Fire Data"),
    path('update_stic_sec_13_Data/' , views.update_stic_sec_13_Data, name="STIP Sec 13 Fire Data"),
    path('update_stic_sec_14_Data/' , views.update_stic_sec_14_Data, name="STIP Sec 14 Fire Data"),
    path('update_stic_sec_15_Data/' , views.update_stic_sec_15_Data, name="STIP Sec 15 Fire Data"),
    path('update_stic_sec_16_Data/' , views.update_stic_sec_16_Data, name="STIP Sec 16 Fire Data"),
    path('update_stic_sec_17_Data/' , views.update_stic_sec_17_Data, name="STIP Sec 17 Fire Data"),
    path('update_stic_sec_18_Data/' , views.update_stic_sec_18_Data, name="STIP Sec 18 Fire Data"),
    path('update_stic_sec_19_Data/' , views.update_stic_sec_19_Data, name="STIP Sec 19 Fire Data"),
    path('update_stic_sec_20_Data/' , views.update_stic_sec_20_Data, name="STIP Sec 20 Fire Data"),
    path('update_stic_sec_21_Data/' , views.update_stic_sec_21_Data, name="STIP Sec 21 Fire Data"),
    # PDF Form
