...
from .models import AssuranceInvestment, AssuranceRisk, EmployeeBenefits, InvestmentPlanning, RiskPlanning, ShortTermInsuranceCommerical, ShortTermInsurancePersonal, UserAccount, Form, Fiduciary, GapCover
...
class ShortTermInsurancePersonalSerializers(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.STIP_CnRI_HC_Recomm = validated_data.get("STIP_CnRI_HC_Recomm", instance.STIP_CnRI_HC_Recomm)
        instance.STIP_CnRI_HC_Accepted = validated_data.get("STIP_CnRI_HC_Accepted", instance.STIP_CnRI_HC_Accepted)
        instance.STIP_CnRI_HC_CoverAmount = validated_data.get("STIP_CnRI_HC_CoverAmount", instance.STIP_CnRI_HC_CoverAmount)
        instance.STIP_CnRI_HC_Premium = validated_data.get("STIP_CnRI_HC_Premium", instance.STIP_CnRI_HC_Premium)
        instance.STIP_CnRI_HC_Excess = validated_data.get("STIP_CnRI_HC_Excess", instance.STIP_CnRI_HC_Excess)

        instance.STIP_CnRI_Build_Recomm = validated_data.get("STIP_CnRI_Build_Recomm", instance.STIP_CnRI_Build_Recomm)
        instance.STIP_CnRI_Build_Accepted = validated_data.get("STIP_CnRI_Build_Accepted", instance.STIP_CnRI_Build_Accepted)
        instance.STIP_CnRI_Build_CoverAmount = validated_data.get("STIP_CnRI_Build_CoverAmount", instance.STIP_CnRI_Build_CoverAmount)
        instance.STIP_CnRI_Build_Premium = validated_data.get("STIP_CnRI_Build_Premium", instance.STIP_CnRI_Build_Premium)
        instance.STIP_CnRI_Build_Excess = validated_data.get("STIP_CnRI_Build_Excess", instance.STIP_CnRI_Build_Excess)

        instance.STIP_CnRI_SnL_Recomm = validated_data.get("STIP_CnRI_SnL_Recomm", instance.STIP_CnRI_SnL_Recomm)
        instance.STIP_CnRI_SnL_Accepted = validated_data.get("STIP_CnRI_SnL_Accepted", instance.STIP_CnRI_SnL_Accepted)
        instance.STIP_CnRI_SnL_CoverAmount = validated_data.get("STIP_CnRI_SnL_CoverAmount", instance.STIP_CnRI_SnL_CoverAmount)
        instance.STIP_CnRI_SnL_Premium = validated_data.get("STIP_CnRI_SnL_Premium", instance.STIP_CnRI_SnL_Premium)
        instance.STIP_CnRI_SnL_Excess = validated_data.get("STIP_CnRI_SnL_Excess", instance.STIP_CnRI_SnL_Excess)

        instance.STIP_CnRI_AccidentDam_Recomm = validated_data.get("STIP_CnRI_AccidentDam_Recomm", instance.STIP_CnRI_AccidentDam_Recomm)
        instance.STIP_CnRI_AccidentDam_Accepted = validated_data.get("STIP_CnRI_AccidentDam_Accepted", instance.STIP_CnRI_AccidentDam_Accepted)
        instance.STIP_CnRI_AccidentDam_CoverAmount = validated_data.get("STIP_CnRI_AccidentDam_CoverAmount", instance.STIP_CnRI_AccidentDam_CoverAmount)
        instance.STIP_CnRI_AccidentDam_Premium = validated_data.get("STIP_CnRI_AccidentDam_Premium", instance.STIP_CnRI_AccidentDam_Premium)
        instance.STIP_CnRI_AccidentDam_Excess = validated_data.get("STIP_CnRI_AccidentDam_Excess", instance.STIP_CnRI_AccidentDam_Excess)

        instance.STIP_CnRI_Risks_Recomm = validated_data.get("STIP_CnRI_Risks_Recomm", instance.STIP_CnRI_Risks_Recomm)
        instance.STIP_CnRI_Risks_Accepted = validated_data.get("STIP_CnRI_Risks_Accepted", instance.STIP_CnRI_Risks_Accepted)
        instance.STIP_CnRI_Risks_CoverAmount = validated_data.get("STIP_CnRI_Risks_CoverAmount", instance.STIP_CnRI_Risks_CoverAmount)
        instance.STIP_CnRI_Risks_Premium = validated_data.get("STIP_CnRI_Risks_Premium", instance.STIP_CnRI_Risks_Premium)
        instance.STIP_CnRI_Risks_Excess = validated_data.get("STIP_CnRI_Risks_Excess", instance.STIP_CnRI_Risks_Excess)

        instance.STIP_CnRI_CnP_Recomm = validated_data.get("STIP_CnRI_CnP_Recomm", instance.STIP_CnRI_CnP_Recomm)
        instance.STIP_CnRI_CnP_Accepted = validated_data.get("STIP_CnRI_CnP_Accepted", instance.STIP_CnRI_CnP_Accepted)
        instance.STIP_CnRI_CnP_CoverAmount = validated_data.get("STIP_CnRI_CnP_CoverAmount", instance.STIP_CnRI_CnP_CoverAmount)
        instance.STIP_CnRI_CnP_Premium = validated_data.get("STIP_CnRI_CnP_Premium", instance.STIP_CnRI_CnP_Premium)
        instance.STIP_CnRI_CnP_Excess = validated_data.get("STIP_CnRI_CnP_Excess", instance.STIP_CnRI_CnP_Excess)

        instance.STIP_CnRI_KnL_Recomm = validated_data.get("STIP_CnRI_KnL_Recomm", instance.STIP_CnRI_KnL_Recomm)
        instance.STIP_CnRI_KnL_Accepted = validated_data.get("STIP_CnRI_KnL_Accepted", instance.STIP_CnRI_KnL_Accepted)
        instance.STIP_CnRI_KnL_CoverAmount = validated_data.get("STIP_CnRI_KnL_CoverAmount", instance.STIP_CnRI_KnL_CoverAmount)
        instance.STIP_CnRI_KnL_Premium = validated_data.get("STIP_CnRI_KnL_Premium", instance.STIP_CnRI_KnL_Premium)
        instance.STIP_CnRI_KnL_Excess = validated_data.get("STIP_CnRI_KnL_Excess", instance.STIP_CnRI_KnL_Excess)

        instance.STIP_CnRI_WhC_Recomm = validated_data.get("STIP_CnRI_WhC_Recomm", instance.STIP_CnRI_WhC_Recomm)
        instance.STIP_CnRI_WhC_Accepted = validated_data.get("STIP_CnRI_WhC_Accepted", instance.STIP_CnRI_WhC_Accepted)
        instance.STIP_CnRI_WhC_CoverAmount = validated_data.get("STIP_CnRI_WhC_CoverAmount", instance.STIP_CnRI_WhC_CoverAmount)
        instance.STIP_CnRI_WhC_Premium = validated_data.get("STIP_CnRI_WhC_Premium", instance.STIP_CnRI_WhC_Premium)
        instance.STIP_CnRI_WhC_Excess = validated_data.get("STIP_CnRI_WhC_Excess", instance.STIP_CnRI_WhC_Excess)

        instance.STIP_CnRI_BiCy_Recomm = validated_data.get("STIP_CnRI_BiCy_Recomm", instance.STIP_CnRI_BiCy_Recomm)
        instance.STIP_CnRI_BiCy_Accepted = validated_data.get("STIP_CnRI_BiCy_Accepted", instance.STIP_CnRI_BiCy_Accepted)
        instance.STIP_CnRI_BiCy_CoverAmount = validated_data.get("STIP_CnRI_BiCy_CoverAmount", instance.STIP_CnRI_BiCy_CoverAmount)
        instance.STIP_CnRI_BiCy_Premium = validated_data.get("STIP_CnRI_BiCy_Premium", instance.STIP_CnRI_BiCy_Premium)
        instance.STIP_CnRI_BiCy_Excess = validated_data.get("STIP_CnRI_BiCy_Excess", instance.STIP_CnRI_BiCy_Excess)

        instance.STIP_CnRI_CellPhone_Recomm = validated_data.get("STIP_CnRI_CellPhone_Recomm", instance.STIP_CnRI_CellPhone_Recomm)
        instance.STIP_CnRI_CellPhone_Accepted = validated_data.get("STIP_CnRI_CellPhone_Accepted", instance.STIP_CnRI_CellPhone_Accepted)
        instance.STIP_CnRI_CellPhone_CoverAmount = validated_data.get("STIP_CnRI_CellPhone_CoverAmount", instance.STIP_CnRI_CellPhone_CoverAmount)
        instance.STIP_CnRI_CellPhone_Premium = validated_data.get("STIP_CnRI_CellPhone_Premium", instance.STIP_CnRI_CellPhone_Premium)
        instance.STIP_CnRI_CellPhone_Excess = validated_data.get("STIP_CnRI_CellPhone_Excess", instance.STIP_CnRI_CellPhone_Excess)

        instance.STIP_CnRI_Decoder_Recomm = validated_data.get("STIP_CnRI_Decoder_Recomm", instance.STIP_CnRI_Decoder_Recomm)
        instance.STIP_CnRI_Decoder_Accepted = validated_data.get("STIP_CnRI_Decoder_Accepted", instance.STIP_CnRI_Decoder_Accepted)
        instance.STIP_CnRI_Decoder_CoverAmount = validated_data.get("STIP_CnRI_Decoder_CoverAmount", instance.STIP_CnRI_Decoder_CoverAmount)
        instance.STIP_CnRI_Decoder_Premium = validated_data.get("STIP_CnRI_Decoder_Premium", instance.STIP_CnRI_Decoder_Premium)
        instance.STIP_CnRI_Decoder_Excess = validated_data.get("STIP_CnRI_Decoder_Excess", instance.STIP_CnRI_Decoder_Excess)

        instance.STIP_CnRI_RisksSp_Recomm = validated_data.get("STIP_CnRI_RisksSp_Recomm", instance.STIP_CnRI_RisksSp_Recomm)
        instance.STIP_CnRI_RisksSp_Accepted = validated_data.get("STIP_CnRI_RisksSp_Accepted", instance.STIP_CnRI_RisksSp_Accepted)
        instance.STIP_CnRI_RisksSp_CoverAmount = validated_data.get("STIP_CnRI_RisksSp_CoverAmount", instance.STIP_CnRI_RisksSp_CoverAmount)
        instance.STIP_CnRI_RisksSp_Premium = validated_data.get("STIP_CnRI_RisksSp_Premium", instance.STIP_CnRI_RisksSp_Premium)
        instance.STIP_CnRI_RisksSp_Excess = validated_data.get("STIP_CnRI_RisksSp_Excess", instance.STIP_CnRI_RisksSp_Excess)

        instance.STIP_CnRI_CompEquip_Recomm = validated_data.get("STIP_CnRI_CompEquip_Recomm", instance.STIP_CnRI_CompEquip_Recomm)
        instance.STIP_CnRI_CompEquip_Accepted = validated_data.get("STIP_CnRI_CompEquip_Accepted", instance.STIP_CnRI_CompEquip_Accepted)
        instance.STIP_CnRI_CompEquip_CoverAmount = validated_data.get("STIP_CnRI_CompEquip_CoverAmount", instance.STIP_CnRI_CompEquip_CoverAmount)
        instance.STIP_CnRI_CompEquip_Premium = validated_data.get("STIP_CnRI_CompEquip_Premium", instance.STIP_CnRI_CompEquip_Premium)
        instance.STIP_CnRI_CompEquip_Excess = validated_data.get("STIP_CnRI_CompEquip_Excess", instance.STIP_CnRI_CompEquip_Excess)

        instance.STIP_CnRI_ItemInVault_Recomm = validated_data.get("STIP_CnRI_ItemInVault_Recomm", instance.STIP_CnRI_ItemInVault_Recomm)
        instance.STIP_CnRI_ItemInVault_Accepted = validated_data.get("STIP_CnRI_ItemInVault_Accepted", instance.STIP_CnRI_ItemInVault_Accepted)
        instance.STIP_CnRI_ItemInVault_CoverAmount = validated_data.get("STIP_CnRI_ItemInVault_CoverAmount", instance.STIP_CnRI_ItemInVault_CoverAmount)
        instance.STIP_CnRI_ItemInVault_Premium = validated_data.get("STIP_CnRI_ItemInVault_Premium", instance.STIP_CnRI_ItemInVault_Premium)
        instance.STIP_CnRI_ItemInVault_Excess = validated_data.get("STIP_CnRI_ItemInVault_Excess", instance.STIP_CnRI_ItemInVault_Excess)

        instance.STIP_CnRI_Jewel_Recomm = validated_data.get("STIP_CnRI_Jewel_Recomm", instance.STIP_CnRI_Jewel_Recomm)
        instance.STIP_CnRI_Jewel_Accepted = validated_data.get("STIP_CnRI_Jewel_Accepted", instance.STIP_CnRI_Jewel_Accepted)
        instance.STIP_CnRI_Jewel_CoverAmount = validated_data.get("STIP_CnRI_Jewel_CoverAmount", instance.STIP_CnRI_Jewel_CoverAmount)
        instance.STIP_CnRI_Jewel_Premium = validated_data.get("STIP_CnRI_Jewel_Premium", instance.STIP_CnRI_Jewel_Premium)
        instance.STIP_CnRI_Jewel_Excess = validated_data.get("STIP_CnRI_Jewel_Excess", instance.STIP_CnRI_Jewel_Excess)

        instance.STIP_CnRI_PhotoGraphic_Recomm = validated_data.get("STIP_CnRI_PhotoGraphic_Recomm", instance.STIP_CnRI_PhotoGraphic_Recomm)
        instance.STIP_CnRI_PhotoGraphic_Accepted = validated_data.get("STIP_CnRI_PhotoGraphic_Accepted", instance.STIP_CnRI_PhotoGraphic_Accepted)
        instance.STIP_CnRI_PhotoGraphic_CoverAmount = validated_data.get("STIP_CnRI_PhotoGraphic_CoverAmount", instance.STIP_CnRI_PhotoGraphic_CoverAmount)
        instance.STIP_CnRI_PhotoGraphic_Premium = validated_data.get("STIP_CnRI_PhotoGraphic_Premium", instance.STIP_CnRI_PhotoGraphic_Premium)
        instance.STIP_CnRI_PhotoGraphic_Excess = validated_data.get("STIP_CnRI_PhotoGraphic_Excess", instance.STIP_CnRI_PhotoGraphic_Excess)

        instance.STIP_CnRI_Sound_Recomm = validated_data.get("STIP_CnRI_Sound_Recomm", instance.STIP_CnRI_Sound_Recomm)
        instance.STIP_CnRI_Sound_Accepted = validated_data.get("STIP_CnRI_Sound_Accepted", instance.STIP_CnRI_Sound_Accepted)
        instance.STIP_CnRI_Sound_CoverAmount = validated_data.get("STIP_CnRI_Sound_CoverAmount", instance.STIP_CnRI_Sound_CoverAmount)
        instance.STIP_CnRI_Sound_Premium = validated_data.get("STIP_CnRI_Sound_Premium", instance.STIP_CnRI_Sound_Premium)
        instance.STIP_CnRI_Sound_Excess = validated_data.get("STIP_CnRI_Sound_Excess", instance.STIP_CnRI_Sound_Excess)
        instance.STIP_CnRI_PhotoGraphic_Excess = validated_data.get("STIP_CnRI_PhotoGraphic_Excess", instance.STIP_CnRI_PhotoGraphic_Excess)

        instance.STIP_CnRI_OtherRecomm = validated_data.get("STIP_CnRI_OtherRecomm", instance.STIP_CnRI_OtherRecomm)
        instance.STIP_CnRI_OtherAccepted = validated_data.get("STIP_CnRI_OtherAccepted", instance.STIP_CnRI_OtherAccepted)
        instance.STIP_CnRI_OtherCoverAmount = validated_data.get("STIP_CnRI_OtherCoverAmount", instance.STIP_CnRI_OtherCoverAmount)
        instance.STIP_CnRI_OtherPremium = validated_data.get("STIP_CnRI_OtherPremium", instance.STIP_CnRI_OtherPremium)
        instance.STIP_CnRI_OtherExcess = validated_data.get("STIP_CnRI_OtherExcess", instance.STIP_CnRI_OtherExcess)

        instance.STIP_CnRI_PLL_Recomm = validated_data.get("STIP_CnRI_PLL_Recomm", instance.STIP_CnRI_PLL_Recomm)
        instance.STIP_CnRI_PLL_Accepted = validated_data.get("STIP_CnRI_PLL_Accepted", instance.STIP_CnRI_PLL_Accepted)
        instance.STIP_CnRI_PLL_CoverAmount = validated_data.get("STIP_CnRI_PLL_CoverAmount", instance.STIP_CnRI_PLL_CoverAmount)
        instance.STIP_CnRI_PLL_Premium = validated_data.get("STIP_CnRI_PLL_Premium", instance.STIP_CnRI_PLL_Premium)
        instance.STIP_CnRI_PLL_Excess = validated_data.get("STIP_CnRI_PLL_Excess", instance.STIP_CnRI_PLL_Excess)

        instance.STIP_CnRI_PLIP_Recomm = validated_data.get("STIP_CnRI_PLIP_Recomm", instance.STIP_CnRI_PLIP_Recomm)
        instance.STIP_CnRI_PLIP_Accepted = validated_data.get("STIP_CnRI_PLIP_Accepted", instance.STIP_CnRI_PLIP_Accepted)
        instance.STIP_CnRI_PLIP_CoverAmount = validated_data.get("STIP_CnRI_PLIP_CoverAmount", instance.STIP_CnRI_PLIP_CoverAmount)
        instance.STIP_CnRI_PLIP_Premium = validated_data.get("STIP_CnRI_PLIP_Premium", instance.STIP_CnRI_PLIP_Premium)
        instance.STIP_CnRI_PLIP_Excess = validated_data.get("STIP_CnRI_PLIP_Excess", instance.STIP_CnRI_PLIP_Excess)

        instance.STIP_CnRI_Vehicle_Recomm = validated_data.get("STIP_CnRI_Vehicle_Recomm", instance.STIP_CnRI_Vehicle_Recomm)
        instance.STIP_CnRI_Vehicle_Accepted = validated_data.get("STIP_CnRI_Vehicle_Accepted", instance.STIP_CnRI_Vehicle_Accepted)
        instance.STIP_CnRI_Vehicle_CoverAmount = validated_data.get("STIP_CnRI_Vehicle_CoverAmount", instance.STIP_CnRI_Vehicle_CoverAmount)
        instance.STIP_CnRI_Vehicle_Premium = validated_data.get("STIP_CnRI_Vehicle_Premium", instance.STIP_CnRI_Vehicle_Premium)
        instance.STIP_CnRI_Vehicle_Excess = validated_data.get("STIP_CnRI_Vehicle_Excess", instance.STIP_CnRI_Vehicle_Excess)

        instance.STIP_CnRI_CarHire_Recomm = validated_data.get("STIP_CnRI_CarHire_Recomm", instance.STIP_CnRI_CarHire_Recomm)
        instance.STIP_CnRI_CarHire_Accepted = validated_data.get("STIP_CnRI_CarHire_Accepted", instance.STIP_CnRI_CarHire_Accepted)
        instance.STIP_CnRI_CarHire_CoverAmount = validated_data.get("STIP_CnRI_CarHire_CoverAmount", instance.STIP_CnRI_CarHire_CoverAmount)
        instance.STIP_CnRI_CarHire_Premium = validated_data.get("STIP_CnRI_CarHire_Premium", instance.STIP_CnRI_CarHire_Premium)
        instance.STIP_CnRI_CarHire_Excess = validated_data.get("STIP_CnRI_CarHire_Excess", instance.STIP_CnRI_CarHire_Excess)

        instance.STIP_CnRI_ExcessW_Recomm = validated_data.get("STIP_CnRI_ExcessW_Recomm", instance.STIP_CnRI_ExcessW_Recomm)
        instance.STIP_CnRI_ExcessW_Accepted = validated_data.get("STIP_CnRI_ExcessW_Accepted", instance.STIP_CnRI_ExcessW_Accepted)
        instance.STIP_CnRI_ExcessW_CoverAmount = validated_data.get("STIP_CnRI_ExcessW_CoverAmount", instance.STIP_CnRI_ExcessW_CoverAmount)
        instance.STIP_CnRI_ExcessW_Premium = validated_data.get("STIP_CnRI_ExcessW_Premium", instance.STIP_CnRI_ExcessW_Premium)
        instance.STIP_CnRI_ExcessW_Excess = validated_data.get("STIP_CnRI_ExcessW_Excess", instance.STIP_CnRI_ExcessW_Excess)

        instance.STIP_CnRI_Credit_Recomm = validated_data.get("STIP_CnRI_Credit_Recomm", instance.STIP_CnRI_Credit_Recomm)
        instance.STIP_CnRI_Credit_Accepted = validated_data.get("STIP_CnRI_Credit_Accepted", instance.STIP_CnRI_Credit_Accepted)
        instance.STIP_CnRI_Credit_CoverAmount = validated_data.get("STIP_CnRI_Credit_CoverAmount", instance.STIP_CnRI_Credit_CoverAmount)
        instance.STIP_CnRI_Credit_Premium = validated_data.get("STIP_CnRI_Credit_Premium", instance.STIP_CnRI_Credit_Premium)
        instance.STIP_CnRI_Credit_Excess = validated_data.get("STIP_CnRI_Credit_Excess", instance.STIP_CnRI_Credit_Excess)
        instance.STIP_CnRI_ExcessW_Excess = validated_data.get("STIP_CnRI_ExcessW_Excess", instance.STIP_CnRI_ExcessW_Excess)

        instance.STIP_CnRI_WaterC_Recomm = validated_data.get("STIP_CnRI_WaterC_Recomm", instance.STIP_CnRI_WaterC_Recomm)
        instance.STIP_CnRI_WaterC_Accepted = validated_data.get("STIP_CnRI_WaterC_Accepted", instance.STIP_CnRI_WaterC_Accepted)
        instance.STIP_CnRI_WaterC_CoverAmount = validated_data.get("STIP_CnRI_WaterC_CoverAmount", instance.STIP_CnRI_WaterC_CoverAmount)
        instance.STIP_CnRI_WaterC_Premium = validated_data.get("STIP_CnRI_WaterC_Premium", instance.STIP_CnRI_WaterC_Premium)
        instance.STIP_CnRI_WaterC_Excess = validated_data.get("STIP_CnRI_WaterC_Excess", instance.STIP_CnRI_WaterC_Excess)

        instance.STIP_CnRI_Sasria_Recomm = validated_data.get("STIP_CnRI_Sasria_Recomm", instance.STIP_CnRI_Sasria_Recomm)
        instance.STIP_CnRI_Sasria_Accepted = validated_data.get("STIP_CnRI_Sasria_Accepted", instance.STIP_CnRI_Sasria_Accepted)
        instance.STIP_CnRI_Sasria_CoverAmount = validated_data.get("STIP_CnRI_Sasria_CoverAmount", instance.STIP_CnRI_Sasria_CoverAmount)
        instance.STIP_CnRI_Sasria_Premium = validated_data.get("STIP_CnRI_Sasria_Premium", instance.STIP_CnRI_Sasria_Premium)
        instance.STIP_CnRI_Sasria_Excess = validated_data.get("STIP_CnRI_Sasria_Excess", instance.STIP_CnRI_Sasria_Excess)

        instance.STIP_CnRI_LegalA_Recomm = validated_data.get("STIP_CnRI_LegalA_Recomm", instance.STIP_CnRI_LegalA_Recomm)
        instance.STIP_CnRI_LegalA_Accepted = validated_data.get("STIP_CnRI_LegalA_Accepted", instance.STIP_CnRI_LegalA_Accepted)
        instance.STIP_CnRI_LegalA_CoverAmount = validated_data.get("STIP_CnRI_LegalA_CoverAmount", instance.STIP_CnRI_LegalA_CoverAmount)
        instance.STIP_CnRI_LegalA_Premium = validated_data.get("STIP_CnRI_LegalA_Premium", instance.STIP_CnRI_LegalA_Premium)
        instance.STIP_CnRI_LegalA_Excess = validated_data.get("STIP_CnRI_LegalA_Excess", instance.STIP_CnRI_LegalA_Excess)
        ...
        instance.STIP_CnRen_HC_Recomm = validated_data.get("STIP_CnRen_HC_Recomm", instance.STIP_CnRen_HC_Recomm)
        instance.STIP_CnRen_HC_Accepted = validated_data.get("STIP_CnRen_HC_Accepted", instance.STIP_CnRen_HC_Accepted)
        instance.STIP_CnRen_HC_CoverAmount = validated_data.get("STIP_CnRen_HC_CoverAmount", instance.STIP_CnRen_HC_CoverAmount)
        instance.STIP_CnRen_HC_Premium = validated_data.get("STIP_CnRen_HC_Premium", instance.STIP_CnRen_HC_Premium)
        instance.STIP_CnRen_HC_Excess = validated_data.get("STIP_CnRen_HC_Excess", instance.STIP_CnRen_HC_Excess)

        instance.STIP_CnRen_Build_Recomm = validated_data.get("STIP_CnRen_Build_Recomm", instance.STIP_CnRen_Build_Recomm)
        instance.STIP_CnRen_Build_Accepted = validated_data.get("STIP_CnRen_Build_Accepted", instance.STIP_CnRen_Build_Accepted)
        instance.STIP_CnRen_Build_CoverAmount = validated_data.get("STIP_CnRen_Build_CoverAmount", instance.STIP_CnRen_Build_CoverAmount)
        instance.STIP_CnRen_Build_Premium = validated_data.get("STIP_CnRen_Build_Premium", instance.STIP_CnRen_Build_Premium)
        instance.STIP_CnRen_Build_Excess = validated_data.get("STIP_CnRen_Build_Excess", instance.STIP_CnRen_Build_Excess)

        instance.STIP_CnRen_SnL_Recomm = validated_data.get("STIP_CnRen_SnL_Recomm", instance.STIP_CnRen_SnL_Recomm)
        instance.STIP_CnRen_SnL_Accepted = validated_data.get("STIP_CnRen_SnL_Accepted", instance.STIP_CnRen_SnL_Accepted)
        instance.STIP_CnRen_SnL_CoverAmount = validated_data.get("STIP_CnRen_SnL_CoverAmount", instance.STIP_CnRen_SnL_CoverAmount)
        instance.STIP_CnRen_SnL_Premium = validated_data.get("STIP_CnRen_SnL_Premium", instance.STIP_CnRen_SnL_Premium)
        instance.STIP_CnRen_SnL_Excess = validated_data.get("STIP_CnRen_SnL_Excess", instance.STIP_CnRen_SnL_Excess)

        instance.STIP_CnRen_AccidentDam_Recomm = validated_data.get("STIP_CnRen_AccidentDam_Recomm", instance.STIP_CnRen_AccidentDam_Recomm)
        instance.STIP_CnRen_AccidentDam_Accepted = validated_data.get("STIP_CnRen_AccidentDam_Accepted", instance.STIP_CnRen_AccidentDam_Accepted)
        instance.STIP_CnRen_AccidentDam_CoverAmount = validated_data.get("STIP_CnRen_AccidentDam_CoverAmount", instance.STIP_CnRen_AccidentDam_CoverAmount)
        instance.STIP_CnRen_AccidentDam_Premium = validated_data.get("STIP_CnRen_AccidentDam_Premium", instance.STIP_CnRen_AccidentDam_Premium)
        instance.STIP_CnRen_AccidentDam_Excess = validated_data.get("STIP_CnRen_AccidentDam_Excess", instance.STIP_CnRen_AccidentDam_Excess)

        instance.STIP_CnRen_Risks_Recomm = validated_data.get("STIP_CnRen_Risks_Recomm", instance.STIP_CnRen_Risks_Recomm)
        instance.STIP_CnRen_Risks_Accepted = validated_data.get("STIP_CnRen_Risks_Accepted", instance.STIP_CnRen_Risks_Accepted)
        instance.STIP_CnRen_Risks_CoverAmount = validated_data.get("STIP_CnRen_Risks_CoverAmount", instance.STIP_CnRen_Risks_CoverAmount)
        instance.STIP_CnRen_Risks_Premium = validated_data.get("STIP_CnRen_Risks_Premium", instance.STIP_CnRen_Risks_Premium)
        instance.STIP_CnRen_Risks_Excess = validated_data.get("STIP_CnRen_Risks_Excess", instance.STIP_CnRen_Risks_Excess)

        instance.STIP_CnRen_CnP_Recomm = validated_data.get("STIP_CnRen_CnP_Recomm", instance.STIP_CnRen_CnP_Recomm)
        instance.STIP_CnRen_CnP_Accepted = validated_data.get("STIP_CnRen_CnP_Accepted", instance.STIP_CnRen_CnP_Accepted)
        instance.STIP_CnRen_CnP_CoverAmount = validated_data.get("STIP_CnRen_CnP_CoverAmount", instance.STIP_CnRen_CnP_CoverAmount)
        instance.STIP_CnRen_CnP_Premium = validated_data.get("STIP_CnRen_CnP_Premium", instance.STIP_CnRen_CnP_Premium)
        instance.STIP_CnRen_CnP_Excess = validated_data.get("STIP_CnRen_CnP_Excess", instance.STIP_CnRen_CnP_Excess)

        instance.STIP_CnRen_KnL_Recomm = validated_data.get("STIP_CnRen_KnL_Recomm", instance.STIP_CnRen_KnL_Recomm)
        instance.STIP_CnRen_KnL_Accepted = validated_data.get("STIP_CnRen_KnL_Accepted", instance.STIP_CnRen_KnL_Accepted)
        instance.STIP_CnRen_KnL_CoverAmount = validated_data.get("STIP_CnRen_KnL_CoverAmount", instance.STIP_CnRen_KnL_CoverAmount)
        instance.STIP_CnRen_KnL_Premium = validated_data.get("STIP_CnRen_KnL_Premium", instance.STIP_CnRen_KnL_Premium)
        instance.STIP_CnRen_KnL_Excess = validated_data.get("STIP_CnRen_KnL_Excess", instance.STIP_CnRen_KnL_Excess)

        instance.STIP_CnRen_WhC_Recomm = validated_data.get("STIP_CnRen_WhC_Recomm", instance.STIP_CnRen_WhC_Recomm)
        instance.STIP_CnRen_WhC_Accepted = validated_data.get("STIP_CnRen_WhC_Accepted", instance.STIP_CnRen_WhC_Accepted)
        instance.STIP_CnRen_WhC_CoverAmount = validated_data.get("STIP_CnRen_WhC_CoverAmount", instance.STIP_CnRen_WhC_CoverAmount)
        instance.STIP_CnRen_WhC_Premium = validated_data.get("STIP_CnRen_WhC_Premium", instance.STIP_CnRen_WhC_Premium)
        instance.STIP_CnRen_WhC_Excess = validated_data.get("STIP_CnRen_WhC_Excess", instance.STIP_CnRen_WhC_Excess)

        instance.STIP_CnRen_BiCy_Recomm = validated_data.get("STIP_CnRen_BiCy_Recomm", instance.STIP_CnRen_BiCy_Recomm)
        instance.STIP_CnRen_BiCy_Accepted = validated_data.get("STIP_CnRen_BiCy_Accepted", instance.STIP_CnRen_BiCy_Accepted)
        instance.STIP_CnRen_BiCy_CoverAmount = validated_data.get("STIP_CnRen_BiCy_CoverAmount", instance.STIP_CnRen_BiCy_CoverAmount)
        instance.STIP_CnRen_BiCy_Premium = validated_data.get("STIP_CnRen_BiCy_Premium", instance.STIP_CnRen_BiCy_Premium)
        instance.STIP_CnRen_BiCy_Excess = validated_data.get("STIP_CnRen_BiCy_Excess", instance.STIP_CnRen_BiCy_Excess)

        instance.STIP_CnRen_CellPhone_Recomm = validated_data.get("STIP_CnRen_CellPhone_Recomm", instance.STIP_CnRen_CellPhone_Recomm)
        instance.STIP_CnRen_CellPhone_Accepted = validated_data.get("STIP_CnRen_CellPhone_Accepted", instance.STIP_CnRen_CellPhone_Accepted)
        instance.STIP_CnRen_CellPhone_CoverAmount = validated_data.get("STIP_CnRen_CellPhone_CoverAmount", instance.STIP_CnRen_CellPhone_CoverAmount)
        instance.STIP_CnRen_CellPhone_Premium = validated_data.get("STIP_CnRen_CellPhone_Premium", instance.STIP_CnRen_CellPhone_Premium)
        instance.STIP_CnRen_CellPhone_Excess = validated_data.get("STIP_CnRen_CellPhone_Excess", instance.STIP_CnRen_CellPhone_Excess)

        instance.STIP_CnRen_Decoder_Recomm = validated_data.get("STIP_CnRen_Decoder_Recomm", instance.STIP_CnRen_Decoder_Recomm)
        instance.STIP_CnRen_Decoder_Accepted = validated_data.get("STIP_CnRen_Decoder_Accepted", instance.STIP_CnRen_Decoder_Accepted)
        instance.STIP_CnRen_Decoder_CoverAmount = validated_data.get("STIP_CnRen_Decoder_CoverAmount", instance.STIP_CnRen_Decoder_CoverAmount)
        instance.STIP_CnRen_Decoder_Premium = validated_data.get("STIP_CnRen_Decoder_Premium", instance.STIP_CnRen_Decoder_Premium)
        instance.STIP_CnRen_Decoder_Excess = validated_data.get("STIP_CnRen_Decoder_Excess", instance.STIP_CnRen_Decoder_Excess)

        instance.STIP_CnRen_RisksSp_Recomm = validated_data.get("STIP_CnRen_RisksSp_Recomm", instance.STIP_CnRen_RisksSp_Recomm)
        instance.STIP_CnRen_RisksSp_Accepted = validated_data.get("STIP_CnRen_RisksSp_Accepted", instance.STIP_CnRen_RisksSp_Accepted)
        instance.STIP_CnRen_RisksSp_CoverAmount = validated_data.get("STIP_CnRen_RisksSp_CoverAmount", instance.STIP_CnRen_RisksSp_CoverAmount)
        instance.STIP_CnRen_RisksSp_Premium = validated_data.get("STIP_CnRen_RisksSp_Premium", instance.STIP_CnRen_RisksSp_Premium)
        instance.STIP_CnRen_RisksSp_Excess = validated_data.get("STIP_CnRen_RisksSp_Excess", instance.STIP_CnRen_RisksSp_Excess)

        instance.STIP_CnRen_CompEquip_Recomm = validated_data.get("STIP_CnRen_CompEquip_Recomm", instance.STIP_CnRen_CompEquip_Recomm)
        instance.STIP_CnRen_CompEquip_Accepted = validated_data.get("STIP_CnRen_CompEquip_Accepted", instance.STIP_CnRen_CompEquip_Accepted)
        instance.STIP_CnRen_CompEquip_CoverAmount = validated_data.get("STIP_CnRen_CompEquip_CoverAmount", instance.STIP_CnRen_CompEquip_CoverAmount)
        instance.STIP_CnRen_CompEquip_Premium = validated_data.get("STIP_CnRen_CompEquip_Premium", instance.STIP_CnRen_CompEquip_Premium)
        instance.STIP_CnRen_CompEquip_Excess = validated_data.get("STIP_CnRen_CompEquip_Excess", instance.STIP_CnRen_CompEquip_Excess)

        instance.STIP_CnRen_ItemInVault_Recomm = validated_data.get("STIP_CnRen_ItemInVault_Recomm", instance.STIP_CnRen_ItemInVault_Recomm)
        instance.STIP_CnRen_ItemInVault_Accepted = validated_data.get("STIP_CnRen_ItemInVault_Accepted", instance.STIP_CnRen_ItemInVault_Accepted)
        instance.STIP_CnRen_ItemInVault_CoverAmount = validated_data.get("STIP_CnRen_ItemInVault_CoverAmount", instance.STIP_CnRen_ItemInVault_CoverAmount)
        instance.STIP_CnRen_ItemInVault_Premium = validated_data.get("STIP_CnRen_ItemInVault_Premium", instance.STIP_CnRen_ItemInVault_Premium)
        instance.STIP_CnRen_ItemInVault_Excess = validated_data.get("STIP_CnRen_ItemInVault_Excess", instance.STIP_CnRen_ItemInVault_Excess)

        instance.STIP_CnRen_Jewel_Recomm = validated_data.get("STIP_CnRen_Jewel_Recomm", instance.STIP_CnRen_Jewel_Recomm)
        instance.STIP_CnRen_Jewel_Accepted = validated_data.get("STIP_CnRen_Jewel_Accepted", instance.STIP_CnRen_Jewel_Accepted)
        instance.STIP_CnRen_Jewel_CoverAmount = validated_data.get("STIP_CnRen_Jewel_CoverAmount", instance.STIP_CnRen_Jewel_CoverAmount)
        instance.STIP_CnRen_Jewel_Premium = validated_data.get("STIP_CnRen_Jewel_Premium", instance.STIP_CnRen_Jewel_Premium)
        instance.STIP_CnRen_Jewel_Excess = validated_data.get("STIP_CnRen_Jewel_Excess", instance.STIP_CnRen_Jewel_Excess)

        instance.STIP_CnRen_PhotoGraphic_Recomm = validated_data.get("STIP_CnRen_PhotoGraphic_Recomm", instance.STIP_CnRen_PhotoGraphic_Recomm)
        instance.STIP_CnRen_PhotoGraphic_Accepted = validated_data.get("STIP_CnRen_PhotoGraphic_Accepted", instance.STIP_CnRen_PhotoGraphic_Accepted)
        instance.STIP_CnRen_PhotoGraphic_CoverAmount = validated_data.get("STIP_CnRen_PhotoGraphic_CoverAmount", instance.STIP_CnRen_PhotoGraphic_CoverAmount)
        instance.STIP_CnRen_PhotoGraphic_Premium = validated_data.get("STIP_CnRen_PhotoGraphic_Premium", instance.STIP_CnRen_PhotoGraphic_Premium)
        instance.STIP_CnRen_PhotoGraphic_Excess = validated_data.get("STIP_CnRen_PhotoGraphic_Excess", instance.STIP_CnRen_PhotoGraphic_Excess)

        instance.STIP_CnRen_Sound_Recomm = validated_data.get("STIP_CnRen_Sound_Recomm", instance.STIP_CnRen_Sound_Recomm)
        instance.STIP_CnRen_Sound_Accepted = validated_data.get("STIP_CnRen_Sound_Accepted", instance.STIP_CnRen_Sound_Accepted)
        instance.STIP_CnRen_Sound_CoverAmount = validated_data.get("STIP_CnRen_Sound_CoverAmount", instance.STIP_CnRen_Sound_CoverAmount)
        instance.STIP_CnRen_Sound_Premium = validated_data.get("STIP_CnRen_Sound_Premium", instance.STIP_CnRen_Sound_Premium)
        instance.STIP_CnRen_Sound_Excess = validated_data.get("STIP_CnRen_Sound_Excess", instance.STIP_CnRen_Sound_Excess)
        instance.STIP_CnRen_PhotoGraphic_Excess = validated_data.get("STIP_CnRen_PhotoGraphic_Excess", instance.STIP_CnRen_PhotoGraphic_Excess)

        instance.STIP_CnRen_OtherRecomm = validated_data.get("STIP_CnRen_OtherRecomm", instance.STIP_CnRen_OtherRecomm)
        instance.STIP_CnRen_OtherAccepted = validated_data.get("STIP_CnRen_OtherAccepted", instance.STIP_CnRen_OtherAccepted)
        instance.STIP_CnRen_OtherCoverAmount = validated_data.get("STIP_CnRen_OtherCoverAmount", instance.STIP_CnRen_OtherCoverAmount)
        instance.STIP_CnRen_OtherPremium = validated_data.get("STIP_CnRen_OtherPremium", instance.STIP_CnRen_OtherPremium)
        instance.STIP_CnRen_OtherExcess = validated_data.get("STIP_CnRen_OtherExcess", instance.STIP_CnRen_OtherExcess)

        instance.STIP_CnRen_PLL_Recomm = validated_data.get("STIP_CnRen_PLL_Recomm", instance.STIP_CnRen_PLL_Recomm)
        instance.STIP_CnRen_PLL_Accepted = validated_data.get("STIP_CnRen_PLL_Accepted", instance.STIP_CnRen_PLL_Accepted)
        instance.STIP_CnRen_PLL_CoverAmount = validated_data.get("STIP_CnRen_PLL_CoverAmount", instance.STIP_CnRen_PLL_CoverAmount)
        instance.STIP_CnRen_PLL_Premium = validated_data.get("STIP_CnRen_PLL_Premium", instance.STIP_CnRen_PLL_Premium)
        instance.STIP_CnRen_PLL_Excess = validated_data.get("STIP_CnRen_PLL_Excess", instance.STIP_CnRen_PLL_Excess)

        instance.STIP_CnRen_PLIP_Recomm = validated_data.get("STIP_CnRen_PLIP_Recomm", instance.STIP_CnRen_PLIP_Recomm)
        instance.STIP_CnRen_PLIP_Accepted = validated_data.get("STIP_CnRen_PLIP_Accepted", instance.STIP_CnRen_PLIP_Accepted)
        instance.STIP_CnRen_PLIP_CoverAmount = validated_data.get("STIP_CnRen_PLIP_CoverAmount", instance.STIP_CnRen_PLIP_CoverAmount)
        instance.STIP_CnRen_PLIP_Premium = validated_data.get("STIP_CnRen_PLIP_Premium", instance.STIP_CnRen_PLIP_Premium)
        instance.STIP_CnRen_PLIP_Excess = validated_data.get("STIP_CnRen_PLIP_Excess", instance.STIP_CnRen_PLIP_Excess)

        instance.STIP_CnRen_Vehicle_Recomm = validated_data.get("STIP_CnRen_Vehicle_Recomm", instance.STIP_CnRen_Vehicle_Recomm)
        instance.STIP_CnRen_Vehicle_Accepted = validated_data.get("STIP_CnRen_Vehicle_Accepted", instance.STIP_CnRen_Vehicle_Accepted)
        instance.STIP_CnRen_Vehicle_CoverAmount = validated_data.get("STIP_CnRen_Vehicle_CoverAmount", instance.STIP_CnRen_Vehicle_CoverAmount)
        instance.STIP_CnRen_Vehicle_Premium = validated_data.get("STIP_CnRen_Vehicle_Premium", instance.STIP_CnRen_Vehicle_Premium)
        instance.STIP_CnRen_Vehicle_Excess = validated_data.get("STIP_CnRen_Vehicle_Excess", instance.STIP_CnRen_Vehicle_Excess)

        instance.STIP_CnRen_CarHire_Recomm = validated_data.get("STIP_CnRen_CarHire_Recomm", instance.STIP_CnRen_CarHire_Recomm)
        instance.STIP_CnRen_CarHire_Accepted = validated_data.get("STIP_CnRen_CarHire_Accepted", instance.STIP_CnRen_CarHire_Accepted)
        instance.STIP_CnRen_CarHire_CoverAmount = validated_data.get("STIP_CnRen_CarHire_CoverAmount", instance.STIP_CnRen_CarHire_CoverAmount)
        instance.STIP_CnRen_CarHire_Premium = validated_data.get("STIP_CnRen_CarHire_Premium", instance.STIP_CnRen_CarHire_Premium)
        instance.STIP_CnRen_CarHire_Excess = validated_data.get("STIP_CnRen_CarHire_Excess", instance.STIP_CnRen_CarHire_Excess)

        instance.STIP_CnRen_ExcessW_Recomm = validated_data.get("STIP_CnRen_ExcessW_Recomm", instance.STIP_CnRen_ExcessW_Recomm)
        instance.STIP_CnRen_ExcessW_Accepted = validated_data.get("STIP_CnRen_ExcessW_Accepted", instance.STIP_CnRen_ExcessW_Accepted)
        instance.STIP_CnRen_ExcessW_CoverAmount = validated_data.get("STIP_CnRen_ExcessW_CoverAmount", instance.STIP_CnRen_ExcessW_CoverAmount)
        instance.STIP_CnRen_ExcessW_Premium = validated_data.get("STIP_CnRen_ExcessW_Premium", instance.STIP_CnRen_ExcessW_Premium)
        instance.STIP_CnRen_ExcessW_Excess = validated_data.get("STIP_CnRen_ExcessW_Excess", instance.STIP_CnRen_ExcessW_Excess)

        instance.STIP_CnRen_Credit_Recomm = validated_data.get("STIP_CnRen_Credit_Recomm", instance.STIP_CnRen_Credit_Recomm)
        instance.STIP_CnRen_Credit_Accepted = validated_data.get("STIP_CnRen_Credit_Accepted", instance.STIP_CnRen_Credit_Accepted)
        instance.STIP_CnRen_Credit_CoverAmount = validated_data.get("STIP_CnRen_Credit_CoverAmount", instance.STIP_CnRen_Credit_CoverAmount)
        instance.STIP_CnRen_Credit_Premium = validated_data.get("STIP_CnRen_Credit_Premium", instance.STIP_CnRen_Credit_Premium)
        instance.STIP_CnRen_Credit_Excess = validated_data.get("STIP_CnRen_Credit_Excess", instance.STIP_CnRen_Credit_Excess)
        instance.STIP_CnRen_ExcessW_Excess = validated_data.get("STIP_CnRen_ExcessW_Excess", instance.STIP_CnRen_ExcessW_Excess)

        instance.STIP_CnRen_WaterC_Recomm = validated_data.get("STIP_CnRen_WaterC_Recomm", instance.STIP_CnRen_WaterC_Recomm)
        instance.STIP_CnRen_WaterC_Accepted = validated_data.get("STIP_CnRen_WaterC_Accepted", instance.STIP_CnRen_WaterC_Accepted)
        instance.STIP_CnRen_WaterC_CoverAmount = validated_data.get("STIP_CnRen_WaterC_CoverAmount", instance.STIP_CnRen_WaterC_CoverAmount)
        instance.STIP_CnRen_WaterC_Premium = validated_data.get("STIP_CnRen_WaterC_Premium", instance.STIP_CnRen_WaterC_Premium)
        instance.STIP_CnRen_WaterC_Excess = validated_data.get("STIP_CnRen_WaterC_Excess", instance.STIP_CnRen_WaterC_Excess)

        instance.STIP_CnRen_Sasria_Recomm = validated_data.get("STIP_CnRen_Sasria_Recomm", instance.STIP_CnRen_Sasria_Recomm)
        instance.STIP_CnRen_Sasria_Accepted = validated_data.get("STIP_CnRen_Sasria_Accepted", instance.STIP_CnRen_Sasria_Accepted)
        instance.STIP_CnRen_Sasria_CoverAmount = validated_data.get("STIP_CnRen_Sasria_CoverAmount", instance.STIP_CnRen_Sasria_CoverAmount)
        instance.STIP_CnRen_Sasria_Premium = validated_data.get("STIP_CnRen_Sasria_Premium", instance.STIP_CnRen_Sasria_Premium)
        instance.STIP_CnRen_Sasria_Excess = validated_data.get("STIP_CnRen_Sasria_Excess", instance.STIP_CnRen_Sasria_Excess)

        instance.STIP_CnRen_LegalA_Recomm = validated_data.get("STIP_CnRen_LegalA_Recomm", instance.STIP_CnRen_LegalA_Recomm)
        instance.STIP_CnRen_LegalA_Accepted = validated_data.get("STIP_CnRen_LegalA_Accepted", instance.STIP_CnRen_LegalA_Accepted)
        instance.STIP_CnRen_LegalA_CoverAmount = validated_data.get("STIP_CnRen_LegalA_CoverAmount", instance.STIP_CnRen_LegalA_CoverAmount)
        instance.STIP_CnRen_LegalA_Premium = validated_data.get("STIP_CnRen_LegalA_Premium", instance.STIP_CnRen_LegalA_Premium)
        instance.STIP_CnRen_LegalA_Excess = validated_data.get("STIP_CnRen_LegalA_Excess", instance.STIP_CnRen_LegalA_Excess)
        ...
        instance.STIP_Trailer_Fees = validated_data.get("STIP_Trailer_Fee", instance.STIP_Trailer_Fee)
