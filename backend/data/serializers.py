...
from .models import user_profile, bac_model, regions, categorisation, Disclosures, DisclosuresProducts, DisclosuresProductProviders, DisclosuresAdvisorSubCodes
...
class MedicalSerializers(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.MSA_Advisor = validated_data.get("MSA_Advisor", instance.MSA_Advisor)
...
class RiskFactorsSerializers(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        # instance.ClientIndividualRiskScore = validated_data.get("ClientIndividualRiskScore", instance.ClientIndividualRiskScore)
        # instance.ClientIndividualRiskLevel = validated_data.get("ClientIndividualRiskLevel", instance.ClientIndividualRiskLevel)
        # instance.ClientLegalRiskLevelScore = validated_data.get("ClientLegalRiskLevelScore", instance.ClientLegalRiskLevelScore)
        # instance.ClientLegalRiskLevel = validated_data.get("ClientLegalRiskLevel", instance.ClientLegalRiskLevel)
        # instance.TransactionInFlowRiskScore = validated_data.get("TransactionInFlowRiskScore", instance.TransactionInFlowRiskScore)
        # instance.TransactionInFlowRiskLevel = validated_data.get("TransactionInFlowRiskLevel", instance.TransactionInFlowRiskLevel)
        # instance.TransactionOutFlowRiskScore = validated_data.get("TransactionOutFlowRiskScore", instance.TransactionOutFlowRiskScore)
        # instance.TransactionOutFlowRiskLevel = validated_data.get("TransactionOutFlowRiskLevel", instance.TransactionOutFlowRiskLevel)
        # instance.DReputationRiskLevel = validated_data.get("DReputationRiskLevel", instance.DReputationRiskLevel)
        instance.status = validated_data.get("status", instance.status)
...
class AI_Others_Serializer(serializers.ModelSerializer):
    class Meta():
        model = AI_Others
        fields = '__all__'
...
class categorisation_Serializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        return categorisation.objects.create(**validated_data)

class Disclosures_Serializer(serializers.ModelSerializer):
    class Meta():
        model = Disclosures
        fields = '__all__'
...
class DisclosuresProductProviders_Serializer(serializers.ModelSerializer):
    class Meta():
        model = DisclosuresProductProviders
        fields = '__all__'

    def create(self, validated_data):
        return DisclosuresProductProviders.objects.create(**validated_data)

class DisclosuresAdvisorSubCodes_Serializer(serializers.ModelSerializer):
    class Meta():
        model = DisclosuresAdvisorSubCodes
        fields = '__all__'

    def create(self, validated_data):
        return DisclosuresAdvisorSubCodes.objects.create(**validated_data)

class DisclosuresProducts_Serializer(serializers.ModelSerializer):
    class Meta():
        model = DisclosuresProducts
        fields = '__all__'

    def create(self, validated_data):
        return DisclosuresProducts.objects.create(**validated_data)