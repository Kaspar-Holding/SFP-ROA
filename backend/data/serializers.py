...
class UserCreateSerializer(UserCreateSerializer):
    class Meta(UserCreateSerializer.Meta):
        model = User
        fields = ['id', 'email', 'name', 'password', 'is_staff', 'is_superuser', 'admin_id']
...
class ShortTermInsuranceCommericalSerializers(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.STIC_Sec14_Recommended2 = validated_data.get("STIC_Sec14_Recommended2",instance.STIC_Sec14_Recommended2) 
