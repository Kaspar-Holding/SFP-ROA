...
import pytz
from tasks.tasks import compliance_export
...
class ExportData(APIView):
    ...
    def post(self, request):
        data = request.data
        compliance_export.delay(request.user.pk, data)
        return Response({"message": "Export request has been added to the queue and it will be available to download soon in notification bar."})