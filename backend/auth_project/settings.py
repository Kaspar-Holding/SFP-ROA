...
SECRET_KEY = 'django-insecure-!41qni+2$l5583n(p8v@^zopu7a7psb^c=xi9rveymyq%k37mb'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'SFP',
        # Incase of Remote Server
        # 'ENFORCE_SCHEMA': False,
        #     'CLIENT': {
        #         'host': 'mongodb://localhost:27017/SFP?retryWrites=true&w=majority'
...
# import mongoengine
# mongoengine.connect(db="SFP", host="localhost")
# mongoengine.connect(db="SFP", host="localhost", username=username, password=pwd)
