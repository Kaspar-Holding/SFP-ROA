...
const FilterComponent = (props) => {
    ...
    const OnMonthChange = async (e) => {
        ...
        props.monthStats(props.MonthYear+"-"+e.target.value)   
    }
    const OnMonthYearChange = async (e) => {
        ...
        props.monthStats(e.target.value+"-"+props.Month)   
    }
    ...
    const onFromDateChange = async (e) => {
        ...
        props.customStats(e.target.value, props.ToDate)
    }
    ...
    const ChangeFilter = async(e) => {
        ...
        if (e.target.value == 5){
            props.dayStats(yesterday)
            // LoadMonthlyProfile(Moment(yesterday).format('YYYY-MM'))
        }
        if (e.target.value == 1){
            props.annualStats(props.Year)
        } else if (e.target.value == 2){
            
            props.monthStats(props.MonthYear+"-"+props.Month)
        } else if (e.target.value == 3){
            props.dayStats(props.CurrentDate)
        } else if (e.target.value == 4){
            props.customStats(props.FromDate, props.ToDate)
        }
    }
    return (
        <>
