...
const SanlamInsights = () => {
    ...
    const totalSanlamSeries = (name, data, type, name_1, data_1, type_1) => [
        {
            name: name,
            data: data,
            color: '#00788B',
    ...
    const totalSanlamOptions = (categories, title, y_title, y_title1) => ({
        chart: {
            height: 350,
            type: 'line',
            zoom: {
    ...
    const totalRegionSanlamOptions = (categories, title) => ({
        chart: {
            height: 350,
            type: 'line',
            zoom: {
    ...
    const [NonSanlamKPIs, setNonSanlamKPIs] = useState({})
    ...
    const LoadData = async (filterType, year, monthyear, month, date, customFilterType, fromdate, todate, region, advisor, businessType) => {
        ...
        try {
            ...
            setKPIs(response?.data?.data?.sanlam_kpis)
            setNonSanlamKPIs(response?.data?.data?.non_sanlam_kpis)
                                    ...
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                ...
                                                <span className='scoreCard-title'>Total Sanlam Reviews</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                ...
                                                <span className='scoreCard-title'>Total Sanlam Commission</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                ...
                                                <span className='scoreCard-title'>Total Sanlam Regions</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                ...
                                                <span className='scoreCard-title'>Total Sanlam Advisors</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                <h5 className="scoreCard">{ numberFormatter('en-ZA', 0).format(NonSanlamKPIs?.total_reviews) }</h5>
                                                <span className='scoreCard-title'>Total Non Sanlam Reviews</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                <h5 className="scoreCard">{ currencyFormatter('en-ZA', 'ZAR').format(NonSanlamKPIs?.total_commission) }</h5>
                                                <span className='scoreCard-title'>Total Non Sanlam Commission</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                <h5 className="scoreCard">{ numberFormatter('en-ZA', 0).format(NonSanlamKPIs?.total_regions) }</h5>
                                                <span className='scoreCard-title'>Total Non Sanlam Regions</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className="card text-center">
                                            <div className="card-body">
                                                <h5 className="scoreCard">{ numberFormatter('en-ZA', 0).format(NonSanlamKPIs?.total_advisors) }</h5>
                                                <span className='scoreCard-title'>Total Non Sanlam Advisors</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
