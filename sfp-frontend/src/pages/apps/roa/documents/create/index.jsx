        ...
        >
                ...
                <div className='compliance-inital-card'>
                    <div className='position-relative'>
                        <div className='position-absolute top-0 start-50 translate-middle'>
                            <p className='compliance-inital-card-header'>Create Record of Advice Form</p>
                        </div>
                    </div>
            ...
            <div className='row'>
                ...
                <div className='col-lg-8 col-md-6 col-sm-12'>                        
                    <div className="mb-3">
                        <label for="basic-url" className="form-label compliance-inital-card-text">Date</label>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-lg-6 mb-3">
                            <label for="basic-url" className="form-label compliance-inital-card-text">Client ID</label>
                        ...
                        <div className="col-lg-6 mb-3">
                            <label for="basic-url" className="form-label compliance-inital-card-text">Completed By:</label>
                        ...
                        <div className="col-lg-6 mb-3">
                            <label for="basic-url" className="form-label compliance-inital-card-text">Completed By: Role/Designation</label>
