...
const EditROA = () => {
    ...
    const getUserProfile = async (formId) => {

        const Body = JSON.stringify({
            fId: formId
        })
        try {
            const response = await axios.post('/api/roa/profile', Body, config)
    ...
    const getDisclosureProducts = async (formId) => {

        const Body = JSON.stringify({
            fId: formId
        })
        try {
            const response = await axios.post('/api/roa/products', config)
    ...
    useEffect(() => {
        getUserProfile(formId)
        getDisclosureProducts(formId)
        LoadData(formId)
    }, [])
