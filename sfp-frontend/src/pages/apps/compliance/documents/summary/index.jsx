                            ...
                            <div className='position-absolute bottom-0 start-0 w-100'>
                                <div className="container">
                                    <div className={(DocumentInitalData?.status == 0 && DocumentInitalData?.picked_up === user?.id) || DocumentInitalData?.status == 3 ? 'row row-cols-5' : 'row'}>
                                        {
                                            DocumentInitalData?.starting_point == 2 ?
                                            <div className={(DocumentInitalData?.status == 0 && DocumentInitalData?.picked_up === user?.id) || DocumentInitalData?.status != 1 ? 'col' : 'col-lg-3'}>
                                                <p className='calculated_score'>
                                                    Calculated Score {DocumentInitalData?.status != 1 ? "(GK)" : "(Gatekeeping)"}
                                                </p>
                                                <div className='row'>
                                        ...
                                        {
                                            !user?.is_superuser ? 
                                                (user?.userType === 1 && ((DocumentInitalData?.status == 0 && DocumentInitalData?.picked_up === user?.id) || DocumentInitalData?.status != 1)) ? 
                                                <div className={(DocumentInitalData?.status == 0 && DocumentInitalData?.picked_up === user?.id) || DocumentInitalData?.status != 1 ? 'col' : 'col-lg-3'}>
