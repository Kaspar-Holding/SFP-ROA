                ...
                <hr />
                {
                    dId ?
                        <div >
                            ...
                            <span className='value mx-3'>
                                {
                                    DocumentInitalData?.referred ?
                                        DocumentInitalData?.status === 0 ? "New Case" :
                                            DocumentInitalData?.status === 1 ? "Reffered - Approved" :
                                                DocumentInitalData?.status === 2 ? "Reffered - Not Approved" :
                                                    DocumentInitalData?.status === 7 ? "Reffered - Not Approved & Editing" :
                                                        DocumentInitalData?.status === 3 ? "Reffered - Referred" :
                                                            DocumentInitalData?.status === 4 ? "Reffered - Partial Approved" :
                                                                DocumentInitalData?.status === 5 ? "Reffered - Picked Up" : ""
                                        :
                                        DocumentInitalData?.status === 0 ? "New Case" :
                                            DocumentInitalData?.status === 1 ? "Approved" :
                                                DocumentInitalData?.status === 2 ? "Not Approved" :
                                                    DocumentInitalData?.status === 7 ? "Not Approved & Editing" :
                                                        DocumentInitalData?.status === 3 ? "Referred" :
                                                            DocumentInitalData?.status === 4 ? "Partial Approved" :
                                                                DocumentInitalData?.status === 5 ? "Picked Up" : ""
                                }
                            </span>
                            <br />
